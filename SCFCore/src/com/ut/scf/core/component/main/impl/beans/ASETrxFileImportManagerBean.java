...
@Service("aSETrxfileImportManagerBean") 
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class ASETrxFileImportManagerBean extends AbsMainCompManager{
...
//			}
	...
	private void saveTempFile(JSONObject trxData) throws IOException{
		...
		try {
			...
			String serFileName = new Date().getTime()+fileName;//重命名上传文件
