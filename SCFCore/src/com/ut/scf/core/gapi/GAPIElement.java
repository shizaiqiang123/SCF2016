...
public class GAPIElement implements Cloneable {
	/**
	 * 节点名称
	 */
	 ...
	 * 节点对应的父节点
	 */
	private GAPIElement parentEle;

	private List<GAPIElement> childs;
	/**
	...
	public GAPIElement(Element ele) {
	...
	public GAPIElement getParentEle() {
		return parentEle;
	}

	public void setParentEle(GAPIElement parentEle) {
	...
	public GAPIElement getChild(int index) {
		if (childs == null)
			return null;
		return childs.get(index);
	}

	public void addChild(GAPIElement childEle) {
		if (childs == null) {
			childs = new ArrayList<GAPIElement>();
		}
		childs.add(childEle);
	}
	
	public void appendChild(GAPIElement childEle,GAPIElement preEle) {
		if (childs == null) {
			childs = new ArrayList<GAPIElement>();
		}
	...
	public void removeChild(GAPIElement index) {
		if (childs != null)
			childs.remove(index);
	}
	...
	public GAPIElement clone() {
		GAPIElement element = new GAPIElement();
	...
	public boolean equals(Object obj) {
		if (obj instanceof GAPIElement) {
			GAPIElement ele = (GAPIElement) obj;
	...
	public String toString(){
		return String.format("nodeName is [%s], value is [%s]",nodeName,value);
	}
}
