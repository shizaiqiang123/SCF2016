...
@Component("WideInvImport")
public class WideInvImport implements ITemplateReformat {
	
	@Resource(name="refNoManager")  
	IReferenceNo refNoManager;	
	protected IDaoHelper daoHelper;
	private static Logger logger = LoggerFactory.getLogger(WideInvImport.class);
	@Override
