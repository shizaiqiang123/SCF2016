...
@DynamicUpdate(true)
@DynamicInsert(true)
public class ComFun  implements java.io.Serializable {
    ...
    // Fields    
		...
		/** minimal constructor */
	     public ComFun(String sysRefNo, Integer sysEventTimes, String funId) {
				super();
		...
		/** full constructor */
	     public ComFun(String sysRefNo, String sysBusiUnit, String sysOpId,
					...
					String funNm, String funPath,String funStyle,String funUrl,
					String funTitle,String funType,String funLevel,String pageUrl) {
				super();
				this.sysRefNo = sysRefNo;
	    ...
	    @Column(name="FUN_STYLE", length=35)
