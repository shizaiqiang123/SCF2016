...
/**
 * UserInfoM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "user_info_m", schema = "STD")
@DynamicUpdate(true)
@DynamicInsert(true)
public class UserInfoM implements java.io.Serializable {
	...
	/** minimal constructor */
	public UserInfoM(String sysRefNo, String userId, Integer sysEventTimes) {
	...
	/** full constructor */
	public UserInfoM(String sysRefNo, String sysBusiUnit, String email,
			String telPhone, String extTel, String mobPhone, String title,
			...
			String userTp, Timestamp pwdEditDt, Timestamp pwdDueDt,
			String ownerDep, String ownerBrId, String isMgr, String note,
			String userLevel, String roleId, Integer sysEventTimes,
			String userOwnerid, String busiUnit, String firstLanding,
	...
	@Column(name = "first_landing", length = 10)
