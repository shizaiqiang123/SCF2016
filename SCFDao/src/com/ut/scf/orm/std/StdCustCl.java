...
/**
 * StdCustCl entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "std_cust_cl"
,schema="STD"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class StdCustCl implements java.io.Serializable {
	...
	/** minimal constructor */
	public StdCustCl(String sysRefNo, Timestamp sysOpTm, Timestamp sysRelTm, Timestamp sysAuthTm,
			Integer sysEventTimes, String custTp, Timestamp validDt, Timestamp dueDt, Timestamp freezeDt) {
	...
	/** full constructor */
	public StdCustCl(String sysRefNo, String sysOpId, Timestamp sysOpTm, String sysRelId, Timestamp sysRelTm,
			String sysAuthId, Timestamp sysAuthTm, String sysNextOp,String sysFuncName, String sysLockFlag, String sysLockBy,
			String sysFuncId, String sysTrxSts, Integer sysEventTimes, String clDesc, String clParentId, String custId,
			String custTp, String clFrameId, String ccy, BigDecimal creditAmt, Timestamp validDt, Timestamp dueDt,
			String isRecycle, String isAva, String isShare, String rtTp, String isFreeze, Timestamp freezeDt,
			String freezeRsn, BigDecimal exposureAmt) {
		this.sysRefNo = sysRefNo;
