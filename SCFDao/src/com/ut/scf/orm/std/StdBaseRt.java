 ...
 */
@Entity
@Table(name="std_BASE_RT"
,schema="STD"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class StdBaseRt  implements java.io.Serializable {
	...
	/** minimal constructor */
    public StdBaseRt(String sysRefNo) {
        this.sysRefNo = sysRefNo;
    }
    
    /** full constructor */
    public StdBaseRt(String sysRefNo, String sysOpId, Timestamp sysOpTm, String sysRelId, Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm, String sysNextOp, String sysLockFlag, String sysLockBy, String sysFuncId, String sysTrxSts, Integer sysEventTimes, String cityNm, String sysBusiUnit, String sysRelReason) {
        this.sysRefNo = sysRefNo;
	...
	public void setBaseRt(BigDecimal baseRt) {
		this.baseRt = baseRt;
	}
