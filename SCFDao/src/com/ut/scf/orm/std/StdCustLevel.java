 ...
 */
@Entity
@Table(name="std_CUST_LEVEL"
,schema="STD"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class StdCustLevel  implements java.io.Serializable {
	...
	/** minimal constructor */
    public StdCustLevel(String sysRefNo) {
        this.sysRefNo = sysRefNo;
    }
    
    /** full constructor */
    public StdCustLevel(String sysRefNo, String sysOpId, Timestamp sysOpTm, String sysRelId, Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm, String sysNextOp, String sysLockFlag, String sysLockBy, String sysFuncId, String sysTrxSts, Integer sysEventTimes, String cityNm, String sysBusiUnit) {
        this.sysRefNo = sysRefNo;
