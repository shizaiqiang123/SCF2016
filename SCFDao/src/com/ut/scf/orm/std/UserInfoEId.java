...
/**
 * UserInfoEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class UserInfoEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public UserInfoEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UserInfoEId) ) return false;
		 UserInfoEId castOther = ( UserInfoEId ) other; 
