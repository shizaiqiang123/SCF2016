...
public class UserRoleInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public UserRoleInfo(String sysRefNo, Integer sysEventTimes, String userId,
			String roleId,String roleNm) {
		super();
	...
	/** full constructor */
	public UserRoleInfo(String sysRefNo, Integer sysEventTimes,
			String sysBusiUnit, String sysOpId, Timestamp sysOpTm,
			...
			String userId, String roleId,String roleNm) {
		super();
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	...
	@Column(name = "ROLE_ID",nullable = false, length = 35)
	...
	@Column(name = "ROLE_NM", nullable = false, length = 35)
