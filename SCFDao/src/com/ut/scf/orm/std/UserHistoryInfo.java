 ...
 */
@Entity
@Table(name="user_history_info"
,schema="STD"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class UserHistoryInfo  implements java.io.Serializable {
	...
	/** minimal constructor */
    public UserHistoryInfo(String sysRefNo, Integer sysEventTimes) {
        this.sysRefNo = sysRefNo;
        this.sysEventTimes = sysEventTimes;
    }
    
    /** full constructor */
    public UserHistoryInfo(String sysRefNo, String userId, String userName, String userIp, Timestamp userLoginTime, Timestamp userLogoutTime, String sysOpId, Timestamp sysOpTm, String sysRelId, Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm, String sysNextOp, String sysLockFlag, String sysLockBy, String sysFuncId, String sysTrxSts, String sysRelReason, String sysBusiUnit, Integer sysEventTimes) {
        this.sysRefNo = sysRefNo;
        this.userId = userId;
