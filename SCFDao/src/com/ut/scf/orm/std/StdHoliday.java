...
/**
 * StdHoliday entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "std_holiday"
,schema="STD"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class StdHoliday implements java.io.Serializable {
	...
	public StdHoliday(String sysRefNo, Integer sysEventTimes, Integer year,
			Integer month) {
		super();
	...
	/** full constructor */
	public StdHoliday(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, Integer year, Integer month, Integer day,
			String remark, String busiUnit, Timestamp holiday) {
		super();
		this.sysRefNo = sysRefNo;
	...
	// Property accessors
	@Id
	@Column(name = "SYS_REF_NO", unique = true, nullable = false, length = 40)
	...
	@Column(name = "HOLIDAY", nullable = true, length = 19)
