...
@DynamicUpdate(true)
@DynamicInsert(true)
public class OrgInfoEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public OrgInfoEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof OrgInfoEId) ) return false;
		 OrgInfoEId castOther = ( OrgInfoEId ) other; 
