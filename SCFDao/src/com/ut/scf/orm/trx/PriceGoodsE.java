...
/**
 * PriceGoodsE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "PRICE_GOODS_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class PriceGoodsE implements java.io.Serializable {

	// Fields

	private PriceGoodsEId id;
	...
	/** minimal constructor */
	public PriceGoodsE(PriceGoodsEId id, Timestamp sysOpTm) {
		this.id = id;
		this.sysOpTm = sysOpTm;
	}

	/** full constructor */
	public PriceGoodsE(PriceGoodsEId id, String sysOpId, Timestamp sysOpTm,
			String sysRelId, Timestamp sysRelTm, String sysAuthId,
			Timestamp sysAuthTm, String sysNextOp, String sysLockFlag,
			String sysLockBy, String sysFuncId, String sysTrxSts, String refNo,
			String crtfNo, String loanId, String cntrctNo, String buyerId,
			String selId, String billNo, BigDecimal billAmt,
			Timestamp billValDt, Timestamp billDueDt, String adviceNo,
			Timestamp adviceDt, String brandNo, String chassisNo,
			String engineNo, BigDecimal adviceAmt, Timestamp releaseDt,
			String attribute1, String attrvalue1, String attribute2,
			String attrvalue2, String attribute3, String attrvalue3,
			String goodsCata, String CGoodsNm, String producer, String unit,
			String ccy, BigDecimal price, BigDecimal priceNew, String goodsId,
			String collatSpec, String region, Timestamp updateDt,
			String subCata, String sysRelReason, String goodsCataId,
			String subCataId, String goodsCataNm, String subCataNm,
			BigDecimal poInAmt, Integer poInNumY,String sysOrgId) {
		this.id = id;
	...
	public PriceGoodsEId getId() {
		return this.id;
	}

	public void setId(PriceGoodsEId id) {
		this.id = id;
	}
