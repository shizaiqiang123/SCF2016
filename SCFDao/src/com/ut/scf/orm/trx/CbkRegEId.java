...
/**
 * CbkRegEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CbkRegEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public CbkRegEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CbkRegEId) ) return false;
		 CbkRegEId castOther = ( CbkRegEId ) other; 
