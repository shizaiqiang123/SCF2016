...
/**
 * InvcCbkM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "INVC_CBK_M", schema = "TRX")
public class InvcCbkM implements java.io.Serializable {
	...
	/** minimal constructor */
	public InvcCbkM(String sysRefNo, Integer sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	}

	/** full constructor */
	public InvcCbkM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String cntrctNo, String trxId,
			String invId, String invNo, String invCcy, Timestamp cbkDt,
			BigDecimal invAmt, BigDecimal invBal, BigDecimal invLoanBal, BigDecimal invCrnBal,
			String busiTp, String remark, String sysBusiUnit, String buyerId,
			String buyerNm, Timestamp invValDt, Timestamp invDueDt, Timestamp dueDt,
			BigDecimal chgBcAmt, BigDecimal invLoanAval, String invSts, String pcSts,
			BigDecimal crnAmt, String selNm, BigDecimal loanPerc, String temp,
			String invRef, BigDecimal revTrfAmt,String sysOrgId) {
		this.sysRefNo = sysRefNo;
