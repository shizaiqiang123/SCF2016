...
/**
 * TrfRegEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class TrfRegEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public TrfRegEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TrfRegEId) ) return false;
		 TrfRegEId castOther = ( TrfRegEId ) other; 
