...
/**
 * LoanRegM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "LOAN_REG_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class LoanRegM implements java.io.Serializable {
	...
	/** minimal constructor */
	public LoanRegM(String sysRefNo) {
	...
	public LoanRegM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String loanId, String regNo,
	...
	public LoanRegM(String sysRefNo, String sysLockFlag, Integer sysEventTimes) {
		super();
		this.sysRefNo = sysRefNo;
		this.sysLockFlag = sysLockFlag;
		this.sysEventTimes = sysEventTimes;
	...
	@Column(name = "ARRIVAL_DT", precision = 22, scale = 0)
