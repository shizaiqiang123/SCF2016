...
/**
 * CrtfEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CrtfEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public CrtfEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CrtfEId) ) return false;
		 CrtfEId castOther = ( CrtfEId ) other; 
