...
/**
 * GoodsChangeM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "GOODS_CHANGE_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class GoodsChangeM implements java.io.Serializable {
	...
	/** minimal constructor */
	public GoodsChangeM(String sysRefNo, Timestamp sysOpTm,
	...
	/** full constructor */
	public GoodsChangeM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String cntrctNo, String buyerId,
			String selId, String buyerNm, String selNm, String ccy,
			String regId, String regNm, String wareId, String wareNm,
			String wareAdd, String wareContact, Integer fundRt,
			BigDecimal ttlRegAmt, Integer ttlLowPayNum, BigDecimal lmtBal,
			Timestamp lmtValidDt, Timestamp lmtDueDt, Integer minMarginPct,
			String cntrctSts, BigDecimal openLoanAmt, BigDecimal marginBal,
			BigDecimal ttlInVal, BigDecimal ttlOutVal, String busiTp,
