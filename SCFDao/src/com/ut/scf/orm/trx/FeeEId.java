...
@DynamicUpdate(true)
@DynamicInsert(true)
public class FeeEId implements java.io.Serializable {
	...
	/** full constructor */
	public FeeEId(String sysRefNo, Integer sysEventTimes) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FeeEId))
			return false;
		FeeEId castOther = (FeeEId) other;
