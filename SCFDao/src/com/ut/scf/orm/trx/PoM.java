...
/**
 * PoM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "PO_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class PoM implements java.io.Serializable {
	...
	/** minimal constructor */
	public PoM(String sysRefNo, Integer sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	}

	/** full constructor */
	public PoM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			String selId, String buyerNm, String selNm, String poCcy,
			BigDecimal poAmt, Timestamp poDueDt, String poNo, Timestamp trxDt,
			BigDecimal poLoanBal, String trxSts, String sysRelReason,
			String sysFuncName, String busiTp, Integer poNum, String patnerId,
			String patnerNm, String sysOrgId, String isLoan, String isConfirm,
			String confirmFlag, String confirmOp) {
		super();
		this.sysRefNo = sysRefNo;
