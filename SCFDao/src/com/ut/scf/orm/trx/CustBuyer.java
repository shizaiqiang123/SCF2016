...
/**
 * CustBuyer entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "cust_buyer"
,schema="TRX"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class CustBuyer implements java.io.Serializable {
	...
	/** minimal constructor */
	public CustBuyer(String sysRefNo, Integer sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;		
	}

	/** full constructor */
	public CustBuyer(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			String licenceNo, String buyerId,String erpId,String sysGapiSts,String sysOrgId) {
		super();
		this.sysRefNo = sysRefNo;
