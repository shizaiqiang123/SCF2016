...
/**
 * CrtfRegEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CrtfRegEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public CrtfRegEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CrtfRegEId) ) return false;
		 CrtfRegEId castOther = ( CrtfRegEId ) other; 
