...
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcRegEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public InvcRegEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof InvcEId) ) return false;
		 InvcEId castOther = ( InvcEId ) other; 
