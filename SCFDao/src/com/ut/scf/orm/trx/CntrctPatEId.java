...
/**
 * Cntrct_Pat_EId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CntrctPatEId implements java.io.Serializable {
	...
	/** full constructor */
	public CntrctPatEId(String sysRefNo, Integer sysEventTimes) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CntrctPatEId))
			return false;
		CntrctPatEId castOther = (CntrctPatEId) other;
