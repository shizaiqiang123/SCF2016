 ...
 */
@Entity
@Table(name = "FEE_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class FeeE implements java.io.Serializable {
	...
	/** minimal constructor */
	public FeeE(FeeEId id) {
		this.id = id;
	}

	/** full constructor */

	public FeeE(FeeEId id, String sysOpId, Timestamp sysOpTm, String sysRelId,
			Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm,
			String sysNextOp, String sysLockFlag, String sysLockBy,
			String sysFuncId, String sysTrxSts, Timestamp trxDt,
			String costCcy, String costItem, String costItem_desc,
			BigDecimal currTransCost, BigDecimal currTransPayCost,
			String selId, String selAcNo, String selAcNm, String selAcBkNm,
			String remark, BigDecimal currFinCost, BigDecimal currFinPayCost,
			Timestamp createDt, String costPayFlg, String sysGapiSts,
			BigDecimal overdueCost, Timestamp currFinDt,
			Timestamp currFinPayDt, String sysFuncName, String cntrctNo,
			String busiTp, String costTp, BigDecimal costAmt, String theirRef,
