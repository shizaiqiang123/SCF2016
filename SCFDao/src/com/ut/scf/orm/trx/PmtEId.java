...
@DynamicUpdate(true)
@DynamicInsert(true)
public class PmtEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public PmtEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PmtEId) ) return false;
		 PmtEId castOther = ( PmtEId ) other; 
