...
/**
 * GoodsInoutEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class GoodsInoutEId  implements java.io.Serializable {
    ...
    /** default constructor */
    public GoodsInoutEId() {
    }

    
    /** full constructor */
    public GoodsInoutEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof GoodsInoutEId) ) return false;
		 GoodsInoutEId castOther = ( GoodsInoutEId ) other; 
