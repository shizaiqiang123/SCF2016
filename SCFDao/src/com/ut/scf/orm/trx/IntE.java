...
/**
 * IntE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "INT_E", schema = "TRX")
public class IntE implements java.io.Serializable {
	...
	/** minimal constructor */
	public IntE(IntEId id, Timestamp sysOpTm) {
		this.id = id;
		this.sysOpTm = sysOpTm;
	}

	/** full constructor */
	public IntE(IntEId id, String sysOpId, Timestamp sysOpTm, String sysRelId,
			Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm,
			String sysNextOp, String sysLockFlag, String sysLockBy,
			String sysFuncId, String sysTrxSts, String sysGapiSts,
			String sysFuncName, String cntrctNo, Timestamp trxDt, String selId,
			String selAcNo, String selAcNm, String selAcBkNm, String busiTp,
			String intTp, String intCcy, BigDecimal intAmt, BigDecimal currInt,
			BigDecimal currPayInt, Timestamp createDt, String intPayFlg,
			BigDecimal overdueInt, Timestamp currIntDt, Timestamp currIntPayDt,
			String theirRef, String remark,String payIntTp,String sysOrgId) {
		this.id = id;
