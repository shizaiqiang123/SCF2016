 ...
 */
@Entity
@Table(name = "INCOME_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class IncomeE implements java.io.Serializable {

	// Fields

	private IncomeEId id;
	...
	public IncomeE(IncomeEId id) {
		this.id = id;
	}

	/** full constructor */
	public IncomeE(IncomeEId id,String sysOpId, Timestamp sysOpTm,
			...
			Timestamp trxDt, String cntrctNo,String sysFuncName,
			String theirRef, BigDecimal incomeAmt, BigDecimal currIncomeAmt,
			String incomeFlag, String selAcNo, String selAcNm,
	...
	public IncomeEId getId() {
		return this.id;
	}

	public void setId(IncomeEId id) {
		this.id = id;
	}
