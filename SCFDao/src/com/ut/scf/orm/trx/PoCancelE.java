...
/**
 * PoCancelE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "PO_CANCEL_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class PoCancelE implements java.io.Serializable {

	// Fields

	private PoCancelEId id;
	...
	/** minimal constructor */
	public PoCancelE(PoCancelEId id, Timestamp sysOpTm) {
		this.id = id;
		this.sysOpTm = sysOpTm;
	}

	/** full constructor */
	public PoCancelE(PoCancelEId id, String sysOpId, Timestamp sysOpTm,
			...
			double loanPct, double loanRt, Integer loanTimes, double intAmt,
			Timestamp loanValDt, Timestamp loanDueDt, double ttlLoanAmt,
			String busiTp, String selId, String buyerId, String selNm,
			String buyerNm, String serviceReq, Timestamp trxDt,
			double selLmtBal, Timestamp selLmtDueDt, String poNo, String poId,
			double ttlLoanBal, String regNo, String cntrctNo, String ccy,
			Clob sysRelReason, double marginAmt, String marginAcNo,
			double marginCompen, double marginRele, double marginBal,
			double ttlDlvAmt, String sysBusiUnit, String advaPaytype,
			String investorName, String selAcNo, String payIntTp,
			double finChgrt, double loanPerc, Timestamp lastPayDt,
			String rateTp, double rtSpread, double libor, String payChgTp,
			String finaSts, Integer pmtTimes, String selAcNm, String selAcBkNm,
			String selAcBkNo, String sysGapiSts, String sysFuncName,
			String printNumber, String sellerInstCd, String loanTp,
			String loanApplicat, double initMarginPct, double authMarginPct,
			double lmtBal, double lmtAmt, double lmtAvl, String payBailAcno,
			double loanAble, String billNo, Timestamp loanOverdueDt,
			double lmtAllocate, String insureNo, double ttlLoanBalhd,
			String isCollect, double pdgAmt, double payIntAmt,
			double payPrinAmt, double pmtAmt, String sysOrgId,
			String isConfirm, String confirmFlag, Clob confirmOp, double poAmt,
			double cancelAmt, String loanId) {
		super();
		this.id = id;
	...
	public PoCancelEId getId() {
		return this.id;
	}
	

	public void setId(PoCancelEId id) {
		this.id = id;
	}
