...
/**
 * CrtfLoanEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class CrtfLoanEId implements java.io.Serializable {
	...
	/** full constructor */
	public CrtfLoanEId(String sysRefNo, Integer sysEventTimes) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CrtfLoanEId))
			return false;
		CrtfLoanEId castOther = (CrtfLoanEId) other;
