...
/**
 * InvcCbkEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class InvcCbkEId implements java.io.Serializable {
	...
	/** full constructor */
	public InvcCbkEId(String sysRefNo, Integer sysEventTimes) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InvcCbkEId))
			return false;
		InvcCbkEId castOther = (InvcCbkEId) other;
