 ...
 */
@Entity
@Table(name = "BAIL_BILL_M", schema = "TRX")
public class BailBillM implements java.io.Serializable {
	...
	/** minimal constructor */
	public BailBillM(String sysRefNo, Integer sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	}

	/** full constructor */
	public BailBillM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			String billNo, String billCcy, BigDecimal billAmt,
			Timestamp billValDt, Timestamp billDueDt,
