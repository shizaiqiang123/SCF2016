...
/**
 * CustMngr entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "cust_mngr", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CustMngr implements java.io.Serializable {

	// Fields
	private String sysRefNo;
	private String actorNo;
	private String actorName;
	private Timestamp actorDate;
	...
	/** minimal constructor */
	public CustMngr(String sysRefNo, String actorNo, String actorName,
	...
	/** full constructor */
	public CustMngr(String sysRefNo, String actorNo, String actorName,
			Timestamp actorDate, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes,String sysOrgId) {
		this.sysRefNo = sysRefNo;
		this.actorNo = actorNo;
		this.actorName = actorName;
	...
	@Column(name = "ACTOR_NO", nullable = false, length = 35)
	...
	@Column(name = "ACTOR_NAME", nullable = false, length = 35)
	...
	@Column(name = "ACTOR_DATE", length = 19)
	public Timestamp getActorDate() {
		return this.actorDate;
	}

	public void setActorDate(Timestamp actorDate) {
		this.actorDate = actorDate;
	}
