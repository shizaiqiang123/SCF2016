...
/**
 * IntEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class IntEId implements java.io.Serializable {
	...
	/** full constructor */
	public IntEId(String sysRefNo, Integer sysEventTimes) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IntEId))
			return false;
		IntEId castOther = (IntEId) other;
