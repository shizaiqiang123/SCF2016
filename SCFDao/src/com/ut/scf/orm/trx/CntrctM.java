...
/**
 * CntrctM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "cntrct_m", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CntrctM implements java.io.Serializable {
	...
	/** minimal constructor */
	public CntrctM(String sysRefNo, Integer sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	}

	/** full constructor */
	public CntrctM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Timestamp validDt, Timestamp dueDt, Timestamp trxDt, String busiTp,
			String selId, String hanChgCcy, BigDecimal hanChgAmt,
			Integer manChgRt, String lmtCcy, BigDecimal lmtAmt,
			BigDecimal lmtBal, Timestamp lmtValidDt, Timestamp lmtDueDt,
			Integer exposureDay, Integer minMarginPct, String cntrctSts,
			BigDecimal openLoanAmt, String clerkId, String ifId, String ifClId,
			String ifHanChgCcy, BigDecimal ifHanChgAmt, Integer ifCommRt,
			String efId, String efClId, String efHanChgCcy,
			BigDecimal efHanChgAmt, Integer efCommRt, String patnerId,
			String patnerNm, String patnerClId, String patnerHanChgCcy,
			...
			String initThFlg, Integer crtfWarPrd, String insureTp,
			String isPossInsure, String insureLimit, String cmsCustNo,
			BigDecimal pldPerc, String recourseTp, BigDecimal poolLine,
			String bchNm, String paySts, BigDecimal maxDroPerc,
	...
	@Column(name = "APPROVAL_STS", length = 15)
