...
/**
 * CrtfRegM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CRTF_REG_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CrtfRegM implements java.io.Serializable {

	private static final long serialVersionUID = -1861971267516381242L;
	...
	/** minimal constructor */
	public CrtfRegM(String sysRefNo, Integer sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	}

	/** full constructor */
	public CrtfRegM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			String busiTp, String ccy, BigDecimal loanAmt, BigDecimal loanBal,
			Timestamp regDt, String remark, String attribute1,
			String attrvalue1, String attribute2, String attrvalue2,
			String attribute3, String attrvalue3, Timestamp loanValDt,
			Timestamp loanDueDt, String sellerInstCd, String supervisorId,
			String supervisorNm, String warehouseId, String warehouseNm,
			String regId, String regNm, String wareId, String wareNm,
			Double fundRt, BigDecimal regAmt, BigDecimal ttlRegAmt,
			BigDecimal maxDroPerc, String sysRelReason, String goDownNo,String sysOrgId,String loanFlag) {
		super();
		this.sysRefNo = sysRefNo;
