...
/**
 * PartyE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "PARTY_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class PartyE implements java.io.Serializable {
	...
	/** minimal constructor */
	public PartyE(PartyEId id) {
		this.id = id;
	}

	/** full constructor */
	public PartyE(PartyEId id, String sysOpId, Timestamp sysOpTm,
			...
			String patnerNo, String patnerNm, String patnerEnNm,
			String patnerTp, String patnerCtry, String patnerAdr,
			String patnerTel, String patnerFax, String patnerEmail,
			String patnerPostCd, String inspTp, Integer inspDay,
			Timestamp inspDt, String inspector, String contactNm, String isFci,
			String fciNo, String agmSignFlg, String agmNo,
			Timestamp agmValueDt, Timestamp agmDueDt, String patnerLevl,
			String patnerArea, String patnerGoods, String patnerCity,
			String sysRelReason, String lmtCcy, BigDecimal lmtAmt,
			BigDecimal lmtBal, Timestamp lmtValidDt, Timestamp lmtDueDt,
			String lmtFlg, BigDecimal lmtAllocate, BigDecimal lmtRecover,
			String busiTp, String theirRef, String custId, String custNm,
			Timestamp lmtDt,String sysOrgId) {
		this.id = id;
	...
	public PartyEId getId() {
		return this.id;
	}

	public void setId(PartyEId id) {
		this.id = id;
	}
