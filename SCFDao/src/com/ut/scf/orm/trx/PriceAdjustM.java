 ...
 */
@Entity
@Table(name = "PRICE_ADJUST_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class PriceAdjustM implements java.io.Serializable {
	...
	/** minimal constructor */
	public PriceAdjustM(String sysRefNo) {
		this.sysRefNo = sysRefNo;
	}

	/** full constructor */
	public PriceAdjustM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
