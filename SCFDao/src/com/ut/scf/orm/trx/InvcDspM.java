 ...
 */
@Entity
@Table(name = "INVC_DSP_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcDspM implements java.io.Serializable {
	...
	/** minimal constructor */
	public InvcDspM(String sysRefNo, String sysLockFlag, Integer sysEventTimes) {
		super();
	...
	public InvcDspM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String notifyBy, Timestamp trxDt,
			String selId, String selNm, String busiTp, String ttlDspInvNo,
			BigDecimal ttlDspInvAmt, String dspFlag,String sysOrgId) {
		super();
		this.sysRefNo = sysRefNo;
	...
	public InvcDspM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String notifyBy, Timestamp trxDt,
			String selId, String selNm, String busiTp, String ttlDspInvNo,
			BigDecimal ttlDspInvAmt, String dspFlag, String cntrctNo,
			String sysRelReason) {
		super();
		this.sysRefNo = sysRefNo;
		this.sysOpId = sysOpId;
