...
/**
 * InvcEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcDspEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public InvcDspEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof InvcDspEId) ) return false;
		 InvcDspEId castOther = ( InvcDspEId ) other; 
