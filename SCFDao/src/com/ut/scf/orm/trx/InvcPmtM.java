 ...
 */
@Entity
@Table(name="INVC_PMT_M"
,schema="TRX"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcPmtM  implements java.io.Serializable {
	...
	/** minimal constructor */
    public InvcPmtM(String sysRefNo) {
        this.sysRefNo = sysRefNo;
    }
    
    /** full constructor */
    public InvcPmtM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
