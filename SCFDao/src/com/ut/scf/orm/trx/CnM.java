...
/**
 * CnM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="CN_M"
    ,schema="TRX"
...
@DynamicUpdate(true)
@DynamicInsert(true)
public class CnM  implements java.io.Serializable {
	...
	/** minimal constructor */
    public CnM(String sysRefNo, Integer sysEventTimes) {
    ...
    /** full constructor */
    public CnM(String sysRefNo, String sysOpId, Timestamp sysOpTm, String sysRelId, Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm, String sysNextOp, String sysLockFlag, String sysLockBy, String sysFuncId, String sysTrxSts, Integer sysEventTimes,String selId, String selNm, String cnNo, BigDecimal cnAmt, String ccy,String sysOrgId) {
        this.sysRefNo = sysRefNo;
