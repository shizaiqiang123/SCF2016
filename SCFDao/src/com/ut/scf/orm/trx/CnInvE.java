...
/**
 * CnInvE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="CN_INV_E"
    ,schema="TRX"
...
@DynamicUpdate(true)
@DynamicInsert(true)
public class CnInvE  implements java.io.Serializable {
	...
	/** minimal constructor */
    public CnInvE(CnInvEId id, BigDecimal crnAmt) {
        this.id = id;
        this.crnAmt = crnAmt;
    }
    
    /** full constructor */
    public CnInvE(CnInvEId id, String sysOpId, Timestamp sysOpTm, String sysRelId, Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm, String sysNextOp, String sysLockFlag, String sysLockBy, String sysFuncId, String sysTrxSts, String selNm, String buyerNm, String invNo, String invCcy, BigDecimal invBal, BigDecimal invLoanAval, BigDecimal crnAmt, Timestamp invDueDt, String cntrctNo, String invSts, Double loanPerc, String temp, String invRef,String sysOrgId) {
        this.id = id;
    ...
    public CnInvEId getId() {
        return this.id;
    }
    
    public void setId(CnInvEId id) {
        this.id = id;
    }
