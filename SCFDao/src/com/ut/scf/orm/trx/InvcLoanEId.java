...
/**
 * InvcLoanEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcLoanEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public InvcLoanEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof InvcLoanEId) ) return false;
		 InvcLoanEId castOther = ( InvcLoanEId ) other; 
