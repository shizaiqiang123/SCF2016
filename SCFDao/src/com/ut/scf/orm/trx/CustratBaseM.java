...
/**
 * CustratBaseMId entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CUSTRAT_BASE_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)

public class CustratBaseM implements java.io.Serializable {
	...
	/** minimal constructor */
	public CustratBaseM(String sysRefNo,
	...
	/** full constructor */
	public CustratBaseM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String ratName, String className,String sysOrgId) {
		this.sysRefNo = sysRefNo;
