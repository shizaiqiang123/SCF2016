...
/**
 * InvcLoanE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "INVC_LOAN_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcLoanE implements java.io.Serializable {

	// Fields

	private InvcLoanEId id;
	...
	/** minimal constructor */
	public InvcLoanE(InvcLoanEId id, Timestamp sysOpTm, String invcLoanId) {
		this.id = id;
	...
	/** full constructor */
	public InvcLoanE(InvcLoanEId id, String sysOpId, Timestamp sysOpTm,
			...
			String invRef, String invNo, String invCcy, BigDecimal invAmt,
			BigDecimal invBal, BigDecimal invLoanBal, BigDecimal invLoanAmt,
			BigDecimal loanPct, BigDecimal loanRt, Integer loanTimes,
			BigDecimal intAmt, Timestamp loanValDt, Timestamp loanDueDt,
			String invcLoanId, BigDecimal invLoanEbal, String sysBusiUnit,
			Integer eventTimes, Timestamp dueDt, String buyerId,
			String buyerNm, BigDecimal loanAmt, Timestamp invValDt,
			Timestamp invDueDt,String sysOrgId) {
		this.id = id;
	...
	public InvcLoanEId getId() {
		return this.id;
	}

	public void setId(InvcLoanEId id) {
		this.id = id;
	}
	...
	@Column(name = "EVENT_TIMES", precision = 38, scale = 0)
