 ...
 */
@Entity
@Table(name = "COLLAT_CH_E", schema = "TRX")
@DynamicUpdate(true)
public class CollatChE implements java.io.Serializable {

	// Fields

	private CollatChEId id;
	...
	/** minimal constructor */
	public CollatChE(CollatChEId id) {
		this.id = id;
	}

	/** full constructor */
	public CollatChE(CollatChEId id, String sysOpId, Timestamp sysOpTm,
			...
			String cntrctNo, String collatNm, String collatQty,
			String collatCcy, BigDecimal collatVal, BigDecimal price,
			BigDecimal salePrice, BigDecimal ttlLoanAmt, String ttlLoanQty,
			String ttlInQty, BigDecimal ttlInAmt, BigDecimal ttlOutAmt,
			String ttlOutQty, Timestamp arrivalDt, BigDecimal collatRdPrice,
			String regNo, Timestamp collatAdjDt, String collatSpec,
			String collatFact, String qty, String weight, String collatUnit,
			String collatId, String collatOutQty, String outQty,
			String outWeight, String froFlag, String collatQtyBal,
			String loanFlag,String sysOrgId,String goodsId) {
		super();
		this.id = id;
	...
	public CollatChEId getId() {
		return this.id;
	}

	public void setId(CollatChEId id) {
		this.id = id;
	}
