 ...
 */
@Entity
@Table(name = "LOAN_COLLATERAL_E", schema = "TRX")
public class LoanCollateralE implements java.io.Serializable {

	// Fields

	private LoanCollateralEId id;
	...
	/** default constructor */
	public LoanCollateralE() {
	}

	/** minimal constructor */
	public LoanCollateralE(LoanCollateralEId id) {
		this.id = id;
	}

	/** full constructor */
	public LoanCollateralE(LoanCollateralEId id, String sysOpId,
			...
			String sysTrxSts, String cntrctNo, String loanId, String buyerId,
			String selId, String refNo, Long poLoanNum, BigDecimal price,
			BigDecimal poLoanAmt, Long poNum, String remark, String goodsId,
			String goodsNm, String unit, String ccy, String subCata,
			String goodsCata, String producer,String sysOrgId) {
		super();
		this.id = id;
	...
	public LoanCollateralEId getId() {
		return this.id;
	}

	public void setId(LoanCollateralEId id) {
		this.id = id;
	}
