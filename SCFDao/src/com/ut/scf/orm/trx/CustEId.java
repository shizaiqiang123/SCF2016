...
/**
 * CustEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CustEId implements java.io.Serializable {
	...
	/** full constructor */
	public CustEId(String sysRefNo, Integer sysEventTimes) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CustEId))
			return false;
		CustEId castOther = (CustEId) other;
