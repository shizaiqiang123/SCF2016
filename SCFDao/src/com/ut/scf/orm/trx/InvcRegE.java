 ...
 */
@Entity
@Table(name = "INVC_REG_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcRegE implements java.io.Serializable {

	// Fields

	private InvcRegEId id;
	...
	/** minimal constructor */
	public InvcRegE(InvcRegEId id) {
		this.id = id;
	}

	/** full constructor */
	public InvcRegE(InvcRegEId id, String sysOpId, Timestamp sysOpTm,
			...
			String selId, String selNm, String ccy,
			String regNo, BigDecimal regAmt,
			String sysRelReason,String custInstCd,String buyerNm,String buyerId,String sysOrgId,String isConfirm,String confirmFlag,String confirmOp) {
		super();
		this.id = id;
	...
	public InvcRegEId getId() {
		return this.id;
	}


	public void setId(InvcRegEId id) {
		this.id = id;
	}
