...
/**
 * PartyEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class PartyEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public PartyEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PartyEId) ) return false;
		 PartyEId castOther = ( PartyEId ) other; 
