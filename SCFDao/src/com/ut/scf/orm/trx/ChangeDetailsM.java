...
/**
 * ChangeDetailsM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CHANGE_DETAILS_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class ChangeDetailsM implements java.io.Serializable {
	...
	/** default constructor */
	public ChangeDetailsM() {
	}

	/** minimal constructor */
	public ChangeDetailsM(String sysRefNo, Timestamp sysOpTm, Integer sysEventTimes) {
		super();
	...
	/** full constructor */
	public ChangeDetailsM(String sysRefNo, String sysOpId, Timestamp sysOpTm, String sysRelId, Timestamp sysRelTm,
			String sysAuthId, Timestamp sysAuthTm, String sysNextOp, String sysLockFlag, String sysLockBy,
			String sysFuncId, String sysTrxSts, Integer sysEventTimes, String inoutRef, String refNo, String collatNm,
			String collatSpec, String goodsId, String prcollatFact, String collatUnit, String ccy, String qty,
			BigDecimal collatRdPrice, String collatQty, String outQty, BigDecimal collatVal, BigDecimal poOutAmt,
			Timestamp collatAdjDt, Timestamp arrivalDt, String changeFlag,String sysOrgId) {
		super();
		this.sysRefNo = sysRefNo;
