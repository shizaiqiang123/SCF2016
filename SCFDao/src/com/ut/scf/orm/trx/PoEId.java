...
/**
 * PoEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class PoEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public PoEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PoEId) ) return false;
		 PoEId castOther = ( PoEId ) other; 
