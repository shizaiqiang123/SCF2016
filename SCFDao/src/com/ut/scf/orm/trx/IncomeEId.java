...
@DynamicUpdate(true)
@DynamicInsert(true)
public class IncomeEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public IncomeEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IncomeEId) ) return false;
		 IncomeEId castOther = ( IncomeEId ) other; 
