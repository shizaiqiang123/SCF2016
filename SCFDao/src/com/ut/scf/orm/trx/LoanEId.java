...
/**
 * LoanEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class LoanEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public LoanEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LoanEId) ) return false;
		 LoanEId castOther = ( LoanEId ) other; 
