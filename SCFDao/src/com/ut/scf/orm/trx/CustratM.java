...
/**
 * CustratMId entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CUSTRAT_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CustratM implements java.io.Serializable {
	...
	/** minimal constructor */
	public CustratM(String sysRefNo, Timestamp sysOpTm, Integer sysEventTimes) {
	...
	/** full constructor */
	public CustratM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String custRatTp,String sysOrgId) {
		this.sysRefNo = sysRefNo;
