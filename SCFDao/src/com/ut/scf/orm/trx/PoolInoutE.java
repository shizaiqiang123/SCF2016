...
/**
 * PoolInoutE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "POOL_INOUT_E", schema = "TRX")
public class PoolInoutE implements java.io.Serializable {

	// Fields

	private PoolInoutEId id;
	...
	/** minimal constructor */
	public PoolInoutE(PoolInoutEId id, Timestamp sysOpTm) {
		this.id = id;
		this.sysOpTm = sysOpTm;
	}

	/** full constructor */
	public PoolInoutE(PoolInoutEId id, String sysOpId, Timestamp sysOpTm,
			...
			String cntrctNo, String sellerInstCd, String selId, String selNm,
			String busiTp, String ccy, String inoutTp, BigDecimal arBal,
			BigDecimal arAvalLoan, BigDecimal poolLine, BigDecimal openLoanAmt,
			String marginAcNo, BigDecimal marginAmt, Timestamp trxDt,
			Timestamp freezeDueDt, BigDecimal lmtAmt, BigDecimal lmtBal,
	...
	public PoolInoutEId getId() {
		return this.id;
	}

	public void setId(PoolInoutEId id) {
		this.id = id;
	}
