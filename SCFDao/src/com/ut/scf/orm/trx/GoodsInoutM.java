...
/**
 * GoodsInoutM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "GOODS_INOUT_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class GoodsInoutM implements java.io.Serializable {
	...
	/** minimal constructor */
	public GoodsInoutM(String sysRefNo, BigDecimal sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	}

	/** full constructor */
	public GoodsInoutM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			BigDecimal sysEventTimes, String cntrctNo, String busiTp,
			String billId, String billNo, BigDecimal inoutAmt,
			Timestamp inoutDate, BigDecimal loanAmt, BigDecimal loanBal,
			String initBailAcc, BigDecimal initBailBal, String pmtBailAcc,
			Long ttlPayNum, BigDecimal ttlPayAmt, String buyerId, String selId,
			String buyerNm, String selNm, String ccy, String patnerId,
			String patnerNm, Long ttlLowPayNum, BigDecimal ttlYPayAmt,
			String regId, String regNm, String wareId, String wareNm,
			BigDecimal ttlRegAmt, String sysRelReason, String sysOrgId,
			BigDecimal poAmt, BigDecimal ttlLoanAmt, BigDecimal ttlLoanBal,
			BigDecimal ttlOutAmt, BigDecimal ttlOutSureAmt, String loanId,
			String poNo, String isConfirm, String confirmFlag, String confirmOp) {
		super();
		this.sysRefNo = sysRefNo;
