 ...
 */
@Entity
@Table(name = "esb_service_detail", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class EsbServiceDetail implements java.io.Serializable {
	...
	/** default constructor */
	public EsbServiceDetail() {
	}

	/** minimal constructor */
	public EsbServiceDetail(String sysRefNo, Timestamp sysOpTm,
			Timestamp sysRelTm, Timestamp sysAuthTm, Integer sysEventTimes) {
	...
	/** full constructor */
	public EsbServiceDetail(String sysRefNo, String sysOpId, Timestamp sysOpTm,
	...
	@Column(name = "SERVICE_TP", length = 35)
