...
/**
 * BailPayEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class BailPayEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public BailPayEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BailPayEId) ) return false;
		 BailPayEId castOther = ( BailPayEId ) other; 
