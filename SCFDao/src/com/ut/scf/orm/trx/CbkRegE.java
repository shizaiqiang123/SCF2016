...
/**
 * CbkRegE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CBK_REG_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CbkRegE implements java.io.Serializable {

	// Fields

	private CbkRegEId id;
	...
	/** minimal constructor */
	public CbkRegE(CbkRegEId id) {
		this.id = id;
	}

	/** full constructor */
	public CbkRegE(CbkRegEId id, String sysOpId, Timestamp sysOpTm,
			...
			String buyerId, String cntrctNo, String ccy, BigDecimal ttlCbkAmt,
			String busiTp, Timestamp cbkDt, String remark, String sysBusiUnit,
			String selNm, String buyerNm, String cbkTp, String cnNo,
			BigDecimal cnAmt, BigDecimal ttlRevTrfAmt, Integer regNo,
	...
	public CbkRegEId getId() {
		return this.id;
	}

	public void setId(CbkRegEId id) {
		this.id = id;
	}
