...
/**
 * CrtfE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CRTF_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CrtfE implements java.io.Serializable {
	...
	/** minimal constructor */
	public CrtfE(CrtfEId id) {
		this.id = id;
	}

	/** full constructor */
	public CrtfE(CrtfEId id, String sysOpId, Timestamp sysOpTm,
			...
			String crtfNo, String loanId, String cntrctNo, String selId,
			String buyerId, String billNo, BigDecimal billAmt,
			...
			String attrvalue3, String refNo, String goodsCata, String subCata,
			String goodsId, String goodsNm, String region, Timestamp updateDt,
			String unit, String ccy, BigDecimal price, String producer,
			String goodsCataId, String subCataId, String goodsCataNm,
			String subCataNm, Long poInNum, Long poOutNum, Long ttlPoOutNum,
			BigDecimal poOutAmt, BigDecimal poInAmt, String froFlag,
			Long poNum, Long sumPoInNum, String goodsCharacter,String poRef,String sysOrgId) {
		super();
		this.id = id;
	...
	public CrtfEId getId() {
		return this.id;
	}

	public void setId(CrtfEId id) {
		this.id = id;
	}
