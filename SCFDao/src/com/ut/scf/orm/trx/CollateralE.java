...
/**
 * CollateralE entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "COLLATERAL_E", schema = "TRX")
public class CollateralE implements java.io.Serializable {

	// Fields

	private CollateralEId id;
	...
	/** minimal constructor */
	public CollateralE(CollateralEId id) {
		this.id = id;
	}

	/** full constructor */
	public CollateralE(CollateralEId id, String sysOpId, Timestamp sysOpTm,
			...
			String cntrctNo, String poNo, String buyerId, String selId,
			String refNo, String poBrand, String poModel, BigDecimal poPrice,
			Long poNum, BigDecimal ttlAmt, String remark, String goodsId,
			String goodsNm, String unit, String ccy, String goodsCharacter,
			String subCata, String goodsCata, String producer,
			Long poNumUseable, Long poNumUsed, String sysOrgId,
			Timestamp poDueDt) {
		super();
		this.id = id;
	...
	public CollateralEId getId() {
		return this.id;
	}

	public void setId(CollateralEId id) {
		this.id = id;
	}
