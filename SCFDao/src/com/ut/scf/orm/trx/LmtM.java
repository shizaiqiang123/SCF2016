...
/**
 * LmtM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "LMT_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class LmtM implements java.io.Serializable {
	...
	/** minimal constructor */
	public LmtM(String sysRefNo) {
		this.sysRefNo = sysRefNo;
	}

	/** full constructor */
	public LmtM(String sysRefNo,String sysOpId, Timestamp sysOpTm, String sysRelId,
			Timestamp sysRelTm, String sysAuthId, Timestamp sysAuthTm,
			String sysNextOp, String sysLockFlag, String sysLockBy,
			String sysTrxSts, Integer sysEventTimes, String sysFuncId,
			String sysFuncName, String sysBusiUnit, String sysGapiSts,
			BigDecimal lmtAmt, BigDecimal lmtBal, String lmtTp, String lmtSts,
