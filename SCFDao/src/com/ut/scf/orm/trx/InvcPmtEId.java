...
/**
 * BillEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcPmtEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public InvcPmtEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BillEId) ) return false;
		 BillEId castOther = ( BillEId ) other; 
