...
/**
 * BalanceoutM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="BALANCEOUT_M"
    ,schema="TRX"
)
@DynamicUpdate(true)
@DynamicInsert(true)
public class BalanceoutM  implements java.io.Serializable {
