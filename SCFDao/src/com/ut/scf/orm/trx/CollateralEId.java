...
public class CollateralEId  implements java.io.Serializable {
    ...
    /** default constructor */
    public CollateralEId() {
    }

    
    /** full constructor */
    public CollateralEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CollateralEId) ) return false;
		 CollateralEId castOther = ( CollateralEId ) other; 
