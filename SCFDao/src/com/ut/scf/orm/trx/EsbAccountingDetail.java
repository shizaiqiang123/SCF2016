...
/**
 * Esb_Accounting_Detail entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "esb_accounting_detail", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class EsbAccountingDetail implements java.io.Serializable {
	...
	/** default constructor */
	public EsbAccountingDetail() {
	}

	/** minimal constructor */
	public EsbAccountingDetail(String sysRefNo) {
		this.sysRefNo = sysRefNo;
	}

	/** full constructor */
	public EsbAccountingDetail(String sysRefNo, String sysOpId,
			...
			String sysTrxSts, Integer sysEventTimes, String accNo,
			String relRefNo, Integer relEvtNo, String trxDesc, String trxTp,
			BigDecimal amt, Timestamp cretTm, Timestamp updtTm,
			String reconStat, String sysBusiUnit,String sysOrgId) {
		this.sysRefNo = sysRefNo;
