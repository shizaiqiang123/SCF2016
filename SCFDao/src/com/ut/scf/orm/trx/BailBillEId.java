 ...
 */
@Embeddable
public class BailBillEId implements java.io.Serializable {
	...
	/** full constructor */
	public BailBillEId(String sysRefNo, Integer sysEventTimes) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BailBillEId))
			return false;
		BailBillEId castOther = (BailBillEId) other;
