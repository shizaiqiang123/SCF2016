...
/**
 * CntrctEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CntrctEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public CntrctEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CntrctEId) ) return false;
		 CntrctEId castOther = ( CntrctEId ) other; 
