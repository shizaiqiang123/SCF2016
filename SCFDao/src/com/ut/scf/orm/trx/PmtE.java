 ...
 */
@Entity
@Table(name = "PMT_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class PmtE implements java.io.Serializable {
	...
	/** minimal constructor */
	public PmtE(PmtEId id) {
		this.id = id;
	}

	/** full constructor */
	public PmtE(PmtEId id, String sysOpId, Timestamp sysOpTm, String sysRelId,
			...
			BigDecimal ttlPmtAmt, Timestamp pmtDt, Timestamp trxDt,
			String selId, String buyerId, String selNm, String buyerNm,
			String busiTp, String serviceReq, String loanId,
			BigDecimal payIntAmt, BigDecimal payPrinAmt, String poId,
			String sysRelReason, String pmtTp, String sysBusiUnit,
