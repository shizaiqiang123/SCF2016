...
/**
 * BalanceoutE Id entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class BalanceoutEId  implements java.io.Serializable {
    ...
    /** default constructor */
    public BalanceoutEId() {
    }

    
    /** full constructor */
    public BalanceoutEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BalanceoutEId) ) return false;
		 BalanceoutEId castOther = ( BalanceoutEId ) other; 
