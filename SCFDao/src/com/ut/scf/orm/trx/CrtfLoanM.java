...
/**
 * CrtfLoanM entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CRTF_LOAN_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CrtfLoanM implements java.io.Serializable {
	...
	/** minimal constructor */
	public CrtfLoanM(String sysRefNo) {
		this.sysRefNo = sysRefNo;
	}

	/** full constructor */
	public CrtfLoanM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			Integer sysEventTimes, String sysOrgId, String crtfNo,
			BigDecimal crtfAmt, BigDecimal crtfOpenAmt,String loanId,String cntrctNo) {
		this.sysRefNo = sysRefNo;
