 ...
 */
@Entity
@Table(name = "COLLAT_REG_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CollatRegM implements java.io.Serializable {
	...
	/** minimal constructor */
	public CollatRegM(String sysRefNo, Integer sysEventTimes) {
		this.sysRefNo = sysRefNo;
		this.sysEventTimes = sysEventTimes;
	}

	/** full constructor */
	public CollatRegM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			String sysRelReason, String goodsId, String goodsNm, String unit,
			BigDecimal price, String isMortgage, String note, String subCata,
			String producer, String goodsCharacter, String goodsCata,
			String sysOrgId,Timestamp collatAdjDt) {
		super();
		this.sysRefNo = sysRefNo;
