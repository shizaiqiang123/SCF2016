...
/**
 * CntrctSbrEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CntrctSbrEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public CntrctSbrEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CntrctSbrEId) ) return false;
		 CntrctSbrEId castOther = ( CntrctSbrEId ) other; 
