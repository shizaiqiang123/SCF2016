...
/**
 * CollateralEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class LoanCollateralEId  implements java.io.Serializable {
    ...
    /** default constructor */
    public LoanCollateralEId() {
    }

    
    /** full constructor */
    public LoanCollateralEId(String sysRefNo, Integer sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LoanCollateralEId) ) return false;
		 LoanCollateralEId castOther = ( LoanCollateralEId ) other; 
