 ...
 */
@Entity
@Table(name = "LOAN_M", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class LoanM implements java.io.Serializable {
	...
	/** minimal constructor */
	public LoanM(String sysRefNo) {
		this.sysRefNo = sysRefNo;
	}

	/** full constructor */
	public LoanM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			String sysGapiSts, Integer sysEventTimes, BigDecimal loanPct,
			BigDecimal loanRt, Integer loanTimes, BigDecimal intAmt,
			...
			BigDecimal selLmtBal, Timestamp selLmtDueDt, String poNo,
			String poId, BigDecimal ttlLoanBal, BigDecimal ttlLoanBalHD,
			String regNo, String cntrctNo, String ccy, String sysRelReason,
			...
			BigDecimal loanAble, String payBailAcno, String billNo,
			Timestamp loanOverdueDt, String insureNo, String isCollect,
			BigDecimal pdgAmt, BigDecimal payIntAmt, BigDecimal payPrinAmt,
			BigDecimal pmtAmt, String sysOrgId, String isConfirm,
			String confirmFlag, String confirmOp, BigDecimal poAmt,String remark) {
		super();
		this.sysRefNo = sysRefNo;
