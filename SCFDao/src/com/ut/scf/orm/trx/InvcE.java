 ...
 */
@Entity
@Table(name = "INVC_E", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class InvcE implements java.io.Serializable {
	...
	private String inPool;//是否入池0是1否
	...
	/** minimal constructor */
	public InvcE(InvcEId id, String invNo) {
		this.id = id;
		this.invNo = invNo;
	}

	/** full constructor */
	public InvcE(InvcEId id, String sysOpId, Timestamp sysOpTm,
			...
			String sysGapiSts, String cntrctNo, String buyerId, String selId,
			String orderNo, String invNo, String batchNo, Timestamp invDt,
			Timestamp invValDt, Timestamp invDueDt, String invCcy,
			BigDecimal invAmt, BigDecimal invBal, String sysRelReason,
			BigDecimal invLoanBal, String invSts, String busiTp, String adjTp,
			String notes, BigDecimal invLoanAval, String arType,
			Integer acctPeriod, BigDecimal chgBcAmt, String linkInvNo,
			String linkInvRef, String sysBusiUnit, BigDecimal intAmt,
			BigDecimal crnAmt, BigDecimal loanRt, Timestamp lastPayDt,
			String poolSts, String licenceNo, String sysFuncName,
			String buyerNm, BigDecimal acctAmt, Timestamp dueDt,
			BigDecimal loanPerc, BigDecimal loanBalAmt, BigDecimal loanTranAmt,
			BigDecimal loanBillAmt, BigDecimal payTranAmt,
			BigDecimal payBillAmt, BigDecimal payAmt, BigDecimal struLoanAmt,
			Timestamp feeDt, String selNm, BigDecimal dspAmt, Timestamp dspDt,
			String dspFlag, String dspRsn, String otherRsn, String dspRef,
			String fixRsn, String theirRef, BigDecimal revTrfAmt,
			String reTrfNo, BigDecimal cbkAmt,String inPool,String isInvcLoan,String sysOrgId) {
		super();
		this.id = id;
	...
	public InvcEId getId() {
		return this.id;
	}

	public void setId(InvcEId id) {
		this.id = id;
	}
	...
	@Column(name = "LOAN_PERC", length = 35)
	public BigDecimal getLoanPerc() {
		return loanPerc;
	}
