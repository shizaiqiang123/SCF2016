...
/**
 * CnInvEId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
@DynamicUpdate(true)
@DynamicInsert(true)
public class CnInvEId  implements java.io.Serializable {
    ...
    /** full constructor */
    public CnInvEId(String sysRefNo, BigDecimal sysEventTimes) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CnInvEId) ) return false;
		 CnInvEId castOther = ( CnInvEId ) other; 
