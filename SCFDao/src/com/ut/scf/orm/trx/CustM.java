 ...
 */
@Entity
@Table(name = "cust_m", schema = "TRX")
@DynamicUpdate(true)
@DynamicInsert(true)
public class CustM implements java.io.Serializable {
	...
	/** minimal constructor */
	public CustM(String sysRefNo, Integer sysEventTimes, String custNm) {
	...
	/** full constructor */
	public CustM(String sysRefNo, String sysOpId, Timestamp sysOpTm,
			...
			String ctctEmail, BigDecimal lmtAmt, Timestamp validDt,
			Timestamp dueDt, BigDecimal lmtBal, String sysRelReason,
			String sysBusiUnit, String licenceNo, String stateTaxLicno,
			String localTaxLicno, BigDecimal regCapital, String regCcy,
			String fciNo, String regionCd, String cityCd, Timestamp setupDt,
			String busiScope, String regAddr, String officeAddr,
			String ctctPersonTitle, String ccy, String loanCardno,
			String mobPhone, String legalRepNm, String legalRepIdtype,
			String legalRepIdno, String compNature, String remark,
			String busiUnit, BigDecimal lmtAllocate, BigDecimal lmtRecover,
			Timestamp trxDt, String erpId, String custLevel, Timestamp regDt,
			String contactPerson, String email, String legalMobPhone,
			String document, Timestamp arrivalDt, String signSts,
			String sysGapiSts, String sysFuncName, BigDecimal usedBal,
			BigDecimal ableBal, String clientNature, String limiting,
			String custBrId, String countryId, String custMgrId,
