...
function ajaxTable(data){
	...
	$('#ScreenHistory').datagrid({
		...
		columns:[[
					...
					{field:'sysRefNo',title:'还款编号',width:150},
					{field:'sysEventTimes',title:'批次号',width:150},	
					{field:'sysFuncName',title:'批次摘要',width:150},	
					{field:'pmtSts',title:'还款状态',width:150,formatter:pmtStsFormater},
					//{field:'finaSts',title:'融资状态',width:190,formatter:finaStsFormater},
