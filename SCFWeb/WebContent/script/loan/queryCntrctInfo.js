	...
	function pageLoad(win) {
		...
		var data = {'cntrctNo':cntrctNo,'selNm':selNm,'sellerInstCd':sellerInstCd,'busiTp':busiTp,'lmtCcy':lmtCcy};
   ...
   function onResetBtnClick(){
	...
	function ajaxBox(){
		var busiTp = [{"id":'0',"text":"国内有追索权保理"},{"id":'1',"text":"国内无追索权保理"},{"id":'2',"text":"先票款后货"}];
