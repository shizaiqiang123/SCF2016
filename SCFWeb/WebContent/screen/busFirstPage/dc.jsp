...
<body class="demo">
	<div style="margin:50px 0px 0px 50px;padding-bottom:50px">
		<img  class="sr" src="images/flowChart/line5.png">
		<div class="dengji">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000031');">
				<img  src="images/flowChart/ruku.png">
				<span class="world">入库</span>
			</a>
		</div>
		<div class="zhuangrang">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000032');">
		...
		<div class="maifu">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000073');">
		...
		<div class="zhengyi">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000034');">
