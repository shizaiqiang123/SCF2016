...
<body class="demo">
	<div style="margin:50px 0px 0px 50px;padding-bottom:50px">
		...
		<div class="dengji">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000778');">
				<img  src="images/flowChart/dengji.png">
				<span class="world">登记</span>
			</a>
		</div>
		<div class="zhuangrang">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000788');">
				<img  src="images/flowChart/zhuangtuc.png">
				<span class="world">入池</span>
			</a>
		</div>
		<div class="rongzhi">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000781');">
				<img  src="images/flowChart/rongzhi.png">
				<span class="world">融资</span>
			</a>
		</div>
		<div class="maifu">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000805');">
		...
		<div class="zhengyi">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000793');">
				<img  src="images/flowChart/zhengyi.png">
				<span class="world">争议</span>
			</a>
		</div>
		<div class="daixiang">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000801');">
				<img  src="images/flowChart/jeique.png">
				<span class="world">解决</span>
			</a>
		</div>
		<div class="jeique">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000797');">
