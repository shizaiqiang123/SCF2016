...
<body class="demo">
	<div style="margin:50px 0px 0px 50px;padding-bottom:50px">
		<img  class="sr" src="images/flowChart/line.png">
		<div class="dengji">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000616');">
				<img  src="images/flowChart/dengji.png">
				<span class="world">登记</span>
			</a>
		</div>
		<div class="zhuangrang">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000017');">
				<img  src="images/flowChart/zhuangrang.png">
				<span class="world">转让</span>
			</a>
		</div>
		<div class="rongzhi">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000020');">
				<img  src="images/flowChart/rongzhi.png">
				<span class="world">融资</span>
			</a>
		</div>
		<div class="maifu">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000132');">
		...
		<div class="fanzhuanr">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000125');">
				<img  src="images/flowChart/fuanzhuanr.png">
				<span class="world" style="margin-left:17px">反转让</span>
			</a>
		</div>
		<div class="maihuank">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000134');">
				<img  src="images/flowChart/maifu.png">
				<span class="world" style="margin-left:7px">卖方还款</span>
			</a>
		</div>
		...
		<div class="zhengyi">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000618');">
				<img  src="images/flowChart/zhengyi.png">
				<span class="world">争议</span>
			</a>
		</div>
		<div class="daixiang">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000619');">
				<img  src="images/flowChart/jeique.png">
				<span class="world">解决</span>
			</a>
		</div>
		<div class="jeique">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000127');">
