...
<title>客户间接客户还款页面</title>
<script type="text/javascript" src="script/poPmt/poPmt.js"></script>
</head>
<body>
	<div id="loanDiv" style="width: 100%" class="easyui-panel" title="融资信息"
		...
		<form id="loanForm">
			<table class="utTab">
				...
				<tr>
					...
					<!-- <td><input type="hidden" id="lmtAmtHd" name="lmtAmtHd"></td>
    				<td><input type="hidden" id="lmtBalHd" name="lmtBalHd"></td>
    				
    				<td><input type="hidden" id="lmtAllocate" name="lmtAllocate"></td>
    				<td><input type="hidden" id="lmtAllocateHd" name="lmtAllocateHd"></td>
    				
    				<!-- 
    				<td><input type="hidden" id="sysRefNoSbr" name="sysRefNoSbr"></td>
    				<td><input type="hidden" id="cntrctSbrBuyerBal" name="cntrctSbrBuyerBal"></td>
    				<td><input type="hidden" id="cntrctSbrBuyerBalHd" name="cntrctSbrBuyerBalHd"></td>
    				 -->

					<td><input type="hidden" id="buyerlmtAvl" name="buyerlmtAvl"></td>
					<td><input type="hidden" id="buyerlmtAvlHd" name="buyerlmtAvlHd"></td>
