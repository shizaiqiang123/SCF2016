...
<script type="text/javascript" src="script/Report/crtfReport.js"></script>
</head>
<body>
<form id="invcMForm">	
	<div id="invcMDiv" class="easyui-panel" title="合格证列表" data-options="collapsible:true" style="width:100%">
