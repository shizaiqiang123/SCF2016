...
<title>交易首页</title>
<script type="text/javascript" src="script/Report/reportHomePage.js"></script>
	...
	<div id="cntrcHome">
		<form id="cntrcHomeForm">
			...
			<div class="item">	
				...
				<div class="fl item-ifo"><input type="text" class="easyui-validatebox combo" name="custName" id="custName" required="true"  ></input><a class="easyui-linkbutton" icon="icon-search" onclick="showLookUpWindowCust()">查询</a></div>
			</div>
			<div class="item">	
				 <span class="label">查询日期：</span>
				 <div class="fl item-ifo"><input type="text" name="startDt" id="startDt"
							class="easyui-datebox" required="required" data-options="width:'120px',height:'32px',panelWidth:253,validType:'date'"></input>
							<span>至</span>
				 	<input type="text" name="endDt" id="endDt"
							class="easyui-datebox" required="required" data-options="width:'120px',height:'32px',panelWidth:253,validType:'date'"></input></div>
			</div>
	       </div>
	       <div class="item">
