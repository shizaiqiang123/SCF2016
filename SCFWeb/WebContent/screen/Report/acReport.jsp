...
<script type="text/javascript" src="script/Report/acReport.js"></script>
</head>
<body>
<form id="invcMForm">	
	<div id="invcMDiv" class="easyui-panel" title="账号列表" data-options="collapsible:true" style="width:100%">
