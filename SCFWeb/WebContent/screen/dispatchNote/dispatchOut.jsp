...
<script type="text/javascript" src="script/dispatchNote/dispatchOut.js"></script>
</head>
<body class="UTSCF">
		...
		<div id="dispatchDiv" style="width: 100%" class="easyui-panel"
			...
			<table class="utTab">
				...
				<!-- <tr>
					<td>仓库编号：</td>
					<td><input type="text" class="easyui-validatebox combo"
						name="wareId" id="wareId"></input></td>
					<td>仓库名称：</td>
					<td><input type="text" class="easyui-validatebox combo"
						name="wareNm" id="wareNm"></input></td>
				</tr> -->
