...
<script type="text/javascript" src="script/loan/invcLoanPool.js"></script>
</head>
<body class="UTSCF">
	<form id="loanSubmit">
			...
			<table class="utTab">
				...
				<tr>
					...
					<td><input id="loanTp" name="loanTp" class="easyui-combobox"
						data-options="valueField:'id',textField:'text',panelHeight: 'auto',onChange:changeLoanTp"
						editable="false" required="true" value="1"></td> -->
					<td>扣款账号：</td>
				...
				<tr>
					...
					<td>应收账款余额：</td>
					<td><input name="arBal" id="arBal" class="easyui-numberbox"
						editable="false"
				...
				<tr>
					...
					<td><input type="text" name="loanValDt" id="loanValDt"
						...
						data-options="onSelect:countIntAmt"></input></td>
				</tr>
				<tr>
					<td>融资金额：</td>
					<td><input name="ttlLoanAmt" id="ttlLoanAmt" required="true"
				...
				<tr>
					...
					<td><input name="loanRt" id="loanRt"
						...
						data-options="min:0,precision:2,onChange:changeLoanRt,max:100,suffix:'%'"
						required="true"></td>
				...
				<tr>
					...
					<td><input class="easyui-combobox" id="payIntTp"
						...
						editable="false" required="true" /></td>
					<td>利息总金额：</td>
					<td><input name="intAmt" id="intAmt" class="easyui-numberbox"
						data-options="min:0,precision:2,groupSeparator:',',validType:'maxLength[18]'"></input></td>
				</tr>
				<tr id="balTr">
					<td>保证金账号：</td>
				...
				<tr id="amtTr">
					...
					<td><input name="authMarginPct" id="authMarginPct"
						class="easyui-numberbox"
						data-options="min:0,precision:2,max:100,suffix:'%',onChange:setMarginAmt"></td>
					<td>保证金金额：</td>
				...
				<tr>
					...
					<!-- 本次利息实收日期 -->
					<td><input type="hidden" name=" ttlLoanAmtOld"
						id="ttlLoanAmtOld"></td>
				    <!-- 买方额度表流水号 -->
				...
				<tr>
					...
					<td><input type="hidden" name="openLoanAmtOld"
						id="openLoanAmtOld"></td>
