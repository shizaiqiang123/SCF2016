	...
	<div>
		<form id="searchForm">
			<!-- <label>商品ID：</label> <input type="text" name="copyOfGoodsId"
				id="copyOfGoodsId" class="easyui-validatebox combo"
				data-options="validType:'maxLength[35]'" /> <label>商品名称：</label> <input
				type="text" name="copyOfGoodsNm" id="copyOfGoodsNm"
				class="easyui-validatebox combo"
				data-options="validType:'maxLength[35]'" /> <a
				class="easyui-linkbutton" icon="icon-search"
				onclick="searchGoodsCata()">查询</a> -->
