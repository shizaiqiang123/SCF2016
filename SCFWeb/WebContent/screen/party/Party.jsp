			...
			<div id="partyDiv"
				...
				<table class="utTab">
					...
					<tr>
						...
						<td>合作方名称（英文）：</td>
						<td><input type="text" name="patnerEnNm"
							class="easyui-validatebox combo" id="patnerEnNm"
							data-options="validType:'maxLength[70]'"></input></td>
					</tr>
					<tr>
						<td>合作方类型：</td>
					...
					<tr>
						<td>是否已经签署协议：</td>
						<td><input id="agmSignFlg" class="easyui-combobox"
							data-options="valueField:'id',textField:'text',panelHeight: 'auto'"
							editable="false" name="agmSignFlg"></input></td>
						<td>协议编号：</td>
						<td><input type="text" name="agmNo" id="agmNo"
							class="easyui-validatebox combo"
							data-options="validType:'maxLength[35]'"></input></td>
					</tr>
					<tr>
						<td>协议开始日期：</td>
						<td><input type="text" name="agmValueDt" id="agmValueDt"
							class="easyui-datebox" editable="false"></input></td>
						<td>协议终止日期：</td>
						<td><input type="text" name="agmDueDt" id="agmDueDt"
							class="easyui-datebox" editable="false"></input></td>
					</tr>
					<tr>
						<td>授信额度币别：</td>
					...
					<tr>
						...
						<td><input name="lmtBal" id="lmtBal" class="easyui-numberbox"
							data-options="groupSeparator:',', min:0,precision:2" value="0"
							editable="false"></input></td>
						<td>监管质物品种：</td>
						<td><input type="text" name="patnerGoods" id="patnerGoods"
							class="easyui-validatebox combo"></input></td>
					</tr>
					<tr>
						<td>起始日：</td>
					...
					<tr>
						<td>巡仓类型：</td>
						<td><input id="inspTp" class="easyui-combobox"
							data-options="valueField:'id',textField:'text',panelHeight: 'auto'"
							editable="false" name="inspTp"></input></td>
						<td>巡仓人：</td>
						<td><input type="text" name="inspector" id="inspector"
							class="easyui-validatebox combo"
							data-options="validType:'maxLength[35]'"></input></td>
					</tr>
					<tr>
						<td>巡仓日：</td>
						<td><input type="text" name="inspDay" id="inspDay"
							class="easyui-numberbox"
							data-options="validType:['number','maxLength[38]']"></input></td>
						<td>下一个巡仓日期：</td>
						<td><input type="text" name="inspDt" id="inspDt"
							class="easyui-datebox" editable="false"></input></td>
					</tr>
					<tr>
						<td>合作方级别：</td>
						<td><input id="patnerLevl" class="easyui-combobox"
							data-options="valueField:'id',textField:'text',panelHeight: 'auto'"
							editable="false" name="patnerLevl"></input></td>
						<td>合作地区：</td>
						<td><input type="text" name="patnerArea" id="patnerArea"
							class="easyui-validatebox combo"
							data-options="validType:'maxLength[70]'"></input></td>
