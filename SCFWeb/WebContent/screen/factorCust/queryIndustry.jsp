...
<title>行业查询</title>
<script type="text/javascript" src="script/factorCust/queryIndustry.js"></script>
...
<body>
	<div>
		<!-- <form id="searchForm">
		<label>行业编号：</label>
		<input type="text"  name ="sysRefNo" id="sysRefNo" title="编号" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>
		<label>行业名称：</label>
		<input type="text"  name ="industryNm" id="industryNm" title="名称" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>		
				...
				<div class="selectDiv" id="selectDiv">
					...
					<li class="condLists fL clearfix"><span
						class="dsB fL height34"> <input
							...
							name="sysRefNo" id="sysRefNo" placeholder="行业编号" />
					</span></li>
					...
					<li class="condLists fL clearfix"><span
						class="dsB fL height34"> <input
							class="inputM1 combo queryInputStyleThree" type="text"
							name="industryNm" id="industryNm" placeholder="行业名称" />
					</span></li>
				</div>
				<li>
