...
<title>交易首页</title>
<script type="text/javascript" src="script/cntrct/cntrctPageYf.js"></script>
		...
		<form id="cntrcHomeForm">
			...
			<div class="item" id="info">
				<div class="fl item-ifo">
					...
					<input name="lmtDueDt" id="lmtDueDt"  class="easyui-datebox"></input>
					<input type="hidden"  name="lmtBal" id="lmtBal" ></input>
					<input type="hidden"  name="lmtAllocate" id="lmtAllocate" ></input>
