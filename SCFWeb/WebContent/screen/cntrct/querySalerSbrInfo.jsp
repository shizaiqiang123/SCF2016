...
<script type="text/javascript" src="script/cntrct/querySalerSbrInfo.js"></script>
<style type="text/css">
input, button {
	border-width: 0;
	outline: 0;
				...
				<div class="selectDiv" id="selectDiv">
					...
					<li class="condLists fL clearfix"><span
						class="dsB fL height34"> <input
							class="inputM1 combo queryInputStyleThree" name="selId"
							id="selId" placeholder="卖方客户编号" />
					</span></li>
					...
					<li class="condLists fL clearfix"><span class="dsB fL">
							...
							style="border: 1px solid #fff; width: 150px;" name="custInstCd"
					...
					<li class="condLists fL clearfix"><span
						class="dsB fL height34"> <input
							...
							name="selNm" id="selNm" placeholder="卖方客户名称" />
					</span></li>
				</div>
				<li>
