...
<title>查询关联关系中的间接客户信息</title>
<link href="css/zybl/common.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="js/scfjs/Formater.js"></script>
<script type="text/javascript" src="script/cntrct/queryBuyerSbr.js"></script>
<style type="text/css">
input, button {
	border-width: 0;
	outline: 0;
			...
			<div>
				<!-- <ul class="condList clearfix" id="screenDiv">
					<li class="condLists fL clearfix">
						<label class="dsB fL tR">间接客户编号：</label>
						<span class="dsB fL">
							<input type="text" id="buyerId" class="inputM1 combo" name="buyerId" />
						</span>
					</li>
					<li class="condLists fL clearfix"><label class="dsB fL tR">间接客户名称：</label>
						<span class="dsB fL"> <input type="text" id="buyerNm"
							class="inputM1 combo" name="buyerNm" />
					</span></li>
					...
					<div class="selectDiv" id="selectDiv">
						...
						<li class="condLists fL clearfix"><span
							class="dsB fL height34"> <input
								...
								name="buyerId" id="buyerId" placeholder="间接客户编号" />
						</span></li>
						<li class="condLists fL clearfix">
