...
<script type="text/javascript" src="script/cntrct/queryCntrctPat.js"></script>
</head>
<body class="UTSCF">
	<form id="searchForm">
		<div>
			<!-- <label>监管方编号：</label> <input type="text" name="patnerId"
				id="patnerId" title="监管方编号" class="easyui-validatebox combo"
				...
				<div class="selectDiv" id="selectDiv">
					...
					<li class="condLists fL clearfix"><span
						class="dsB fL height34"> <input
							...
							name="patnerId" id="patnerId" placeholder="监管方编号" />
					</span></li>
