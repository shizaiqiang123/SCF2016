...
<script type="text/javascript" src="script/cntrct/Cntrct.js"></script>
</head>
<body>
	<div class="div_ul">
		<form id="cntrctForm">
			<div id="cntrctDiv"
				...
				<table class="utTab">
					...
					<tr>
						...
						<!-- <td>信贷客户编号：</td>
						<td><input type="text" name="cmsCustNo" id="cmsCustNo"
							class="easyui-validatebox combo"
							data-options="validType:'maxLength[35]',onChange:changeCmsCustNo"></input>
													<a class="easyui-linkbutton" icon="icon-add" 							onclick="selLookUpWindowCredit()">同步信息额度</a>
						</td>
						<td>信贷额度编号：</td>
						<td><input type="text" name="cmsCntrctNo" id="cmsCntrctNo"
							onchange="RegVerBox()" class="easyui-validatebox combo"
							data-options="validType:'maxLength[35]'"></input></td> -->
					</tr>
					<tr>
						<td>组织机构号：</td>
					...
					<tr id="Tr3">
						...
						<td id="finaTpTd"><input id="finaTp" name="finaTp" class="easyui-combobox"
							data-options="valueField:'id',textField:'text',panelHeight: 'auto'"
					...
					<tr id="Tr10">
						<td>手续费率：<!-- (原转让费率) --></td>
						<td><input type="text" name="transChgrtTwo" id="transChgrtTwo"
							class="easyui-numberspinner"
							data-options="min:0,precision:2,max:100,suffix:'%'"></input></td>
						<td id = openLoanAmtTlTd>已融资敞口：</td>
						<td id = openLoanAmtTd><input type="text" name="openLoanAmt" id="openLoanAmt"
							class="easyui-numberbox" readOnly = "readOnly"
							data-options="min:0,precision:2,groupSeparator:','"></input></td>
					</tr>
					<tr id="Tr12">
					...
					<tr id="Tr6">
						...
						<td><input type="text" class="easyui-validatebox combo"
							...
							icon="icon-search" onclick="showBuyerLookUpWindow()">查询</a></td>
						<td>核心企业名称：</td>
						<td><input type="text" class="easyui-validatebox combo"
							name="buyerNm" id="buyerNm"></input></td>
					</tr>
					<tr id="Tr9">
						<td>监管机构编号：</td>
						<td><input type="text" class="easyui-validatebox combo"
					...
					<tr id="Tr17">
						...
						class="easyui-numberspinner" required = "true"
						data-options="min:0,precision:2,suffix:'%'"
						></input></td>
					</tr>
					<tr id="Tr8">
					...
					<tr>
						...
						<td><input type="hidden" name="paySts" id="paySts"></td><!-- 为了控制买方和卖方不互通，新建协议时默认此字段为0 -->
					</tr>
					<tr>
						<td><input type="hidden" name="openIntAmt" id="openIntAmt"></td>
						<td><input type="hidden" name="lmtRecover" id="lmtRecover"></td>
						<td><input type="hidden" name="ttlRegAmt" id="ttlRegAmt"></td><!-- 为了在修改时保存库存价值 -->
						<td><input type="hidden" name="regLowestVal" id="regLowestVal"></td><!-- 为了在修改时保存regLowsetVal，赋值给最低库存价值 -->
					</tr>
				</table>
			</div>
			<div id="collatDiv">
					...
					<div id="collatDiv">
						...
						<div id="collatToolbar" style="overflow: hidden">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								...
								style="float: right; margin-right: 14px;">添加</a> <a id="collatRemoveId"
								href="javascript:void(0)" class="easyui-linkbutton"
								iconcls="icon-remove" onclick="deleteCollat()" plain="true"
					...
					<div id="partyDiv">
						...
						<div id="partyToolbar" style="overflow: hidden">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								...
								style="float: right; margin-right: 14px;">添加</a> <a id="patnerRemoveId"
								href="javascript:void(0)" class="easyui-linkbutton"
								iconcls="icon-remove" onclick="deleteParty()" plain="true"
								style="float: right">删除</a>
						</div>
					</div>
				</div>
