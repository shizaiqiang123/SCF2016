...
<script type="text/javascript" src="script/cntrct/addCntrctSbr.js"></script>
</head>
<body>
	<form id="addCntrctSbrForm">
		<div id="addCntrctSbrDiv">
			<table class="utTab">
				...
				<tr>
					<!-- <td>间接客户编号：</td>
    			<td><input type="text"  name="buyerId"  id="buyerId" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'" required="true"><a class="easyui-linkbutton" icon="icon-search" onclick="showLookUpWindow()">查询</a></td> -->
					<td>间接客户组织机构代码：</td>
				...
				<tr id="Tr4">
					...
					<td><input type="text" name="openactGraceDay"
						id="openactGraceDay" required="true" class="easyui-numberspinner"
