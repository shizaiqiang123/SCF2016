...
<html>
<head>
<title>应收款融资签约审核</title>
<link href="css/zybl/common.css" rel="stylesheet" type="text/css" />
<script type="text/javascript"
	src="script/cntrct/verifyLoanAgreement.js"></script>
</head>
			...
			<div class="item">
				...
				<div class="fl item-ifo">
					<input type="text" class="easyui-validatebox combo"
						...
						id="cntrctNo" /> <a href="javascript:void(0)" id="queryCntrct"
						onclick="showCntrct()" class="btn">查看协议文本</a>
				</div>
			</div>
			<div class="item">
			...
			<div class="item">
				...
				<div class="fl item-ifo">
					<input name="loanPerc" id="loanPerc" class="easyui-numberspinner"
						required="true"
						data-options="min:0,max:100,suffix:'%',width:'253px',height:'32px',precision:2,onChange:calculateArAvalLoan" />
				</div>
			</div>
			<div class="item">
			...
			<div class="item">
				...
				<div class="fl item-ifo">
					<input type="text" class="easyui-validatebox combo" name="buyerNm"
						id="buyerNm" /> <input type="hidden" name="trxDt" id="trxDt">
					<input type="hidden" name="lmtSts" id="lmtSts">
				</div>
			</div>
		</div>
			...
			<div id="messageListDiv" style="display: block;">
				<div class="item">
					...
					<div id="messageDiv" style="display: block;">
						<div class="fl item-ifo">
							<input class="easyui-textbox" style="width: 253PX; height: 50px"
								name="sysRelReason"
								data-options="multiline:true,validType:'maxLength[500]'"
								id="sysRelReason" />
						</div>
