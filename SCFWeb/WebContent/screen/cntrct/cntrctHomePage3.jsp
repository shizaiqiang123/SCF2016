...
<title>交易首页</title>
<script type="text/javascript" src="script/cntrct/cntrctHomePage3.js"></script>
	...
	<div id="cntrcHome">
		<form id="cntrcHomeForm">
			...
			<div class="item">
				...
				<div class="fl item-ifo">
				<input type="text" class="easyui-validatebox combo" name="buyerNm" id="buyerNm"  data-options="validType:'maxLength[50]'"></input>
			...
			<div class="item">	
				...
				<div class="fl item-ifo"><input id="invNo"   name="invNo" class="easyui-validatebox combo" 
					data-options="width:'253px',height:'32px',valueField:'id',textField:'text',panelHeight: 'auto',validType:'maxLength[50]'"
				 	editable="false"  ></input></div>
			</div>
