...
<script type="text/javascript" src="script/cntrct/billGoodsCntrct.js"></script>
</head>
<body>
	<div class="div_ul">
		<form id="cntrctForm">
			<div id="cntrctDiv"
				...
				<table class="utTab">
					...
					<tr>
						<td id="transChgrtTd" >手续费率：</td>
						<td id="transChgrtId" ><input type="text" name="transChgrt" id="transChgrt"
							class="easyui-numberspinner" required="true"
							data-options="min:0,precision:2,max:100,suffix:'%'"></input></td>
