...
<script type="text/javascript" src="script/pmt/buyerCntPmt.js"></script>
</head>
<body>
			...
			<table class="utTab">
				...
				<tr>
					...
					<td><input editable="false" required="required" id="acNo"
						...
						<!-- <a class="easyui-linkbutton" icon="icon-search" onclick="showDetail()">保理专户明细</a> -->
					</td>
				</tr>
				<tr>
					<td>核销应收账款总额：</td>
		...
		<div id="invcMDiv">
			...
			<div id="toolbar" style="overflow: hidden;">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					plain="true" style="float: right; margin-right: 14px;">应付账款查询</a> <a
