			...
			<!-- <div class="easyui-panel blockArea panel-body" title="查询条件"
				...
				<ul class="condList clearfix" id="screenDiv">
					...
					<div style="width:90px;float:left">
						<label class="dsB fL tR">协议编号：</label>
						</div>
						<span class="dsB fL">
							<input type="text" id="cntrctNo" class="inputM1 combo" name="cntrctNo" style="float:right" maxlength="35"/>
						</span>
					</li>
					<li class="condLists fL clearfix">
					<div style="width:90px;float:left">
					<label class="dsB fL tR">经销商名称：</label>
					</div>
						<span class="dsB fL"> <input type="text" id="selNm" maxlength="200"/>
					</span></li>
				</ul>
				<ul class="condList clearfix" id="screenDiv">
					<li class="condLists fL clearfix">
					<div style="width:90px;float:left">
						...
						<span class="dsB fL">
							<input type="text" id="sellerInstCd" class="inputM1 combo" name="sellerInstCd" style="float:right" maxlength="30" />
						</span>
					</li>
					<li class="condLists fL clearfix">
					<div style="width:90px;float:left">
					<label class="dsB fL tR">核心企业名称：</label>
					</div>
						<span class="dsB fL"> <input type="text" id="buyerNm" class="inputM1 combo" name="buyerNm" style="float:right" maxlength="50" />
					</span></li>
