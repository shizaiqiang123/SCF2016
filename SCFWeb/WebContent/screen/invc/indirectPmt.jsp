...
<script type="text/javascript" src="script/invc/indirectPmt.js"></script>
</head>
<body>
		...
		<form id="pmtForm">
			<table class="utTab">
				...
				<tr>
					...
					<td>扣款账号：</td>
					<td><input required="required" id="acNo"
						data-options="valueField:'acNo',textField:'acNo',panelHeight: 'auto'"
						name="acNo" class="easyui-combobox"></input></td>
				</tr>
				<tr>
					<td>核销应收账款总额：</td>
					<td><input id="verPmtAmt" name="verPmtAmt"
						data-options="min:0,precision:2,groupSeparator:','"
						class="easyui-numberbox" required="true"></input></td>
					<td>入账金额：</td>
					<td><input type="text" name="ttlPmtAmt" id="ttlPmtAmt"
						class="easyui-numberspinner"
						data-options="min:0,precision:2,groupSeparator:','"></input></td>
				</tr>
				<tr id='Tr6'>
					<td>本次还手续费：</td>
					<td><input type="text" name="payTranAmt"
						data-options="min:0,precision:2,groupSeparator:','"
						id="payTranAmt" class="easyui-numberbox"></input>
					<td>本次还处理费：</td>
					<td><input type="text" name="payBillAmt"
						data-options="min:0,precision:2,groupSeparator:','"
						id="payBillAmt" class="easyui-numberbox"></input></td>
				</tr>
				<tr>
					<td id="collate1">保险公司：</td>
					<td id="collate2"><input id="collatCompNm" name="collatCompNm"
				...
				<tr id="Tr1">
					<td><input id="pmtTp" name="pmtTp" value="2"></td>
		...
		<div id="invcMDiv">
			...
			<div id="toolbar" style="overflow: hidden;">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					id="acceptbutton" data-options="iconCls:'icon-save',plain:true"
					onclick="accept()" style="float: right;">接受改变</a>
			</div>
		</div>
	</div>
