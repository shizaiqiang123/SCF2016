...
<script type="text/javascript" src="script/invc/creditNote2.js"></script>
</head>
<body>
	<form id="creditNoteForm">
				...
				<table class="utTab">
					<tr>
						...
						<input type="text" name="sysRefNo" id="sysRefNo">
							<!-- <a class="easyui-linkbutton" icon="icon-search" onclick="showSysRefNoWindow()">查询</a> -->
						</td>
						<td>协议编号：</td>
						<td>
					...
					<tr>
						...
						<td><input class="easyui-combobox" id=ccy name="ccy"
							...
							style="width: 60px" editable="false" required="true" />
							<input type="text" name="ttlCrnAmt" id="ttlCrnAmt"
		...
		<div class="easyui-panel" title="贷项清单信息" data-options="collapsible:true" style="width: 98%">
			<div id="invcMDiv">
				<table id="invcMTable" cellspacing="0" cellpadding="0" width="100%" iconCls="icon-edit"/>
				<div id="toolbar" style="overflow:hidden;">
					<a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-edit" onclick="editRow()" plain="true" style="float:right;margin-right:14px;">修改</a> 
				</div>
			</div>
		</div>
	</form>
