...
<script type="text/javascript" src="script/invc/loanNoteHistory.js"></script>
</head>
<body>
	<form id="loanForm">
		...
		<div id="loanDiv">
			<div class="easyui-panel" title="发票信息"
				data-options="collapsible:true" style="width: 98%">
				<table id="invcTable" cellspacing="0" cellpadding="0" width="100%"
					iconCls="icon-edit">
				</table>
			</div>
		</div>
