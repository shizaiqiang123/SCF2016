...
<script type="text/javascript" src="script/invc/buyerInvcM.js"></script>
</head>
<body>
	<form id="invcMForm">
		<div id="cntrctDiv" class="easyui-panel" title="基本信息"
			...
			<table class="utTab">
				...
				<tr>
					...
					<td>授信客户名称：</td>
					<td><input type="text" name="selNm" id="selNm" class="easyui-validatebox combo" required="true"></input><a
