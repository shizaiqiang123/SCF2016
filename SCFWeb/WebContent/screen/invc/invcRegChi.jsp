...
<title>池融资应收账款转让页面</title>
<script type="text/javascript" src="js/scfjs/Formater.js"></script>
<script type="text/javascript" src="script/invc/invcRegChi.js"></script>
</head>
<body>
	<form id="invcMForm">
			...
			<table class="utTab">
				...
				<tr>
					<td>
						...
						type="hidden" name="sysRelTm" id="sysRelTm" /> <input
						type="hidden" name="selNm" id="selNm" /> 
					</td>
				</tr>
			</table>
		</div>
