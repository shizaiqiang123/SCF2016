...
<body class="UTSCF" style="width: 100%; margin: 0 auto">
	<div>
		<form id="searchForm">
			<!-- <label>重发次数：</label> <input type="text" name="resendTimesSearch" id="resendTimesSearch" /> 
			<label>异常信息：</label> <input type="text" name="errorMsgSearch" id="errorMsgSearch" /> 
			<label>接口类型：</label> <input type="text" name="gapiTypeSearch" id="gapiTypeSearch" />  -->
			<!-- 				<label>异常类型：</label> <input type="text" -->
			<!-- 					name="expType" id="expType"  class="easyui-validatebox combo" /> -->
			<!-- <a class="easyui-linkbutton" icon="icon-search"
					onclick="SearchPortMonitor()">查询</a> -->
			<ul class="condList clearfix" id="screenDiv">
				...
				<li>
					...
					<div class="catalogQuery" id="querySellerQuery"
						onclick="SearchPortMonitor();"></div>
				</li>
				<div
