				...
				<table align="center" border=0 width=85% class="utTab">
					...
					<tr>
						...
						<td><input type="text" class="easyui-datebox"
							name="pwdEditDt" id="pwdEditDt" editable="false"></input>
						<td>下次修改密码的提示时间：</td>
						<td><input type="text" class="easyui-datebox"
							name="pwdDueDt" id="pwdDueDt" editable="false"></input></td>
					</tr>
					<tr>
						<td>电子邮箱：</td>
						<td><input type="text" class="easyui-validatebox"
						...
						<td><input type="hidden" name="sysRefNo" id="sysRefNo"></input>
							...
							<input type="hidden" id="pwdDueDt" name="pwdDueDt"> <input
							type="hidden" id="userStatus" name="userStatus"> <input
							type="hidden" id="pwdTp" name="pwdTp" value="0" /> <input
					...
					<tr>
						<td><input type="hidden" id="ownerBrId" name="ownerBrId" /></td>
					</tr>
				</table>
			</div>
