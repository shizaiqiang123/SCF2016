...
<body>
	<div id="mainDiv" class="easyui-panel" style="width: 100%; height: 250px"
		...
		<form id="mainForm">
			<table align="center" border=0 width=85% height=60%>
				...
				<tr>
					<td>前缀：</td>
					<td><input type="text" class="easyui-validatebox combo" name="refPrefix"
						id="refPrefix"  data-options="validType:'maxLength[35]'"></input></td>
					<td type="hidden" width="1"></td>
					<td>规则类型：</td>
					<!-- STYLE="WIDTH:160PX;" -->
					<!-- <td>  <select id="refType" name="refType"  class ="easyui-select">  
							<option value="G">全局</option>  
							<option value="U">局部</option>  
							</select>  </td> -->
							<td>
							<input class="easyui-combobox" id="refType"
							name="refType" required="true"
