...
_6._outerWidth(_5.width +2)._outerHeight(_5.height);
...
function setValidate(_2b,_opts){
	$.data(_2b,"combo").options.required = _opts.required || false;
	$.data(_2b,"combo").options.validType = _opts.validType || {};
	var opts = $.extend($.data(_2b,"combo").options,_opts);
	var _2e=$.data(_2b,"combo").combo.find("input.combo-text");
	_2e.validatebox(opts);
	};
function _b(_c){
$(_c).addClass("combo-f").hide();
var _d=$("<span class=\"combo\">"+"</span>").insertAfter(_c);
var _e=$("<div class=\"combo-panel\"></div>").appendTo("body");

var combotext=$("<input type=\"text\" class=\"combo-text lin-textbox\" >").appendTo(_d);
$("<span><span class=\"combo-arrow\"></span></span>").appendTo(_d);
$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_d);
...
return {combo:_d,panel:_e,combotext:combotext};
};
function _11(_12){
...
_3a.find(".combo-text").removeClass("lin-textbox");
_3a.find(".combo-text").addClass("lin-textbox-readonly");
_3a.find(".combo-text").attr("readonly",true);
}else{
_39.disabled=false;
$(_36).removeAttr("disabled");
//_3a.find(".combo-value").removeAttr("disabled");
//_3a.find(".combo-text").removeAttr("disabled");
_3a.find(".combo-text").addClass("lin-textbox");
_3a.find(".combo-text").removeClass("lin-textbox-readonly");
_3a.find(".combo-text").attr("readonly",!_39.editable);
}
};
...
var r=_b(this);
_66=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_62),combo:r.combo,panel:r.panel,combotext:r.combotext,previousValue:null});
...
setValidate:function(jq,params){
	return jq.each(function(){
		setValidate(this,params);
	});
...
$.fn.combo.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:22,panelWidth:null,panelHeight:200,multiple:false,selectOnNavigation:true,separator:",",editable:false,disabled:false,readonly:false,hasDownArrow:true,value:"",delay:200,deltaX:19,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
