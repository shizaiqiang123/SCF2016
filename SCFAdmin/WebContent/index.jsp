		...
		<div class='header' id='bodyHeader'>
			<div class='headerDiv'>
				<ul class='menuUl' style='margin-right:0px'>
					<li class='menuLi'><a class='menuA' onclick="logout()">退出</a><p class='menuP2'>|</p></li>
					<li class='menuHead'><a class='menuA' style='margin-left: 80px;' href='javascript:void(0)' id='userInfo'>${sysUserInfo.userName }</a><div class='userLogo'></div></li>
					<li class='menuHead'><a class='menuA' style='margin-left: 80px;' href='javascript:void(0)' onclick="SCFUtils.onCancelBtnClick();">首页</a><div class='home2' onclick="SCFUtils.onCancelBtnClick();"></div></li>
				</ul>
			</div>
		</div>
