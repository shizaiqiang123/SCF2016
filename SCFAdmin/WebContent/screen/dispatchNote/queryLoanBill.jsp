...
<script type="text/javascript"
	src="script/dispatchNote/queryLoanBill.js"></script>
<style type="text/css">
input, button {
	border-width: 0;
	outline: 0;
			...
			<div>
				<!-- <ul class="condList clearfix" id="screenDiv">
					<li class="condLists fL clearfix">
						<label class="dsB fL tR">票据编号：</label>
						<span class="dsB fL">
							<input type="text" id="billNo" name="billNo" class="inputM1 combo"/>
						</span>
					</li>
					...
					<div class="selectDiv" id="selectDiv">
						...
						<li class="condLists fL clearfix"><span
							class="dsB fL height34"> <input
								...
								name="billNo" id="billNo" placeholder="票据编号" />
						</span></li>
					</div>
					<li class="condLists fL clearfix"><label class="dsB fL tR"></label>
