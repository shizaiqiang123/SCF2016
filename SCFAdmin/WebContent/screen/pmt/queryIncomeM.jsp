...
<script type="text/javascript" src="script/pmt/queryIncomeM.js"></script>
<style type="text/css">
input,button {
	border-width: 0;
	outline: 0;
		...
		<form id="mainform">
			<div class="easyui-panel blockArea panel-body" title="查询条件"
				...
				<ul class="condList clearfix" id="screenDiv">
					<li class="condLists fL clearfix"><label class="dsB fL tR">协议编号：</label>
						<span class="dsB fL"> <input type="text" id="cntrctNo"
							class="inputM1 combo" name="cntrctNo" />
					</span></li>
