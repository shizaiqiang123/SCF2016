...
<script type="text/javascript"
	src="script/PORegist/CollateralRegister.js"></script>
			...
			<table class="utTab" align="center" height="50%">
				...
				<tr>
					...
					<td><input type="text" name="goodsCharacter"
						...
						data-options="validType:'maxLength[32]'"></td>
					<td>生产厂家:</td>
					<td><input type="text" class="easyui-validatebox combo"
				...
				<tr>
					...
					<td>计价币别:</td>
					<td><input type="text" class="easyui-validatebox combo"
						name="ccy" id="ccy" data-options="validType:'maxLength[35]'"></td>
				</tr>
				<tr>
					<td>数量:</td>
				...
				<tr>
					...
					<td>发货到期日：</td>
					<td><input type="text" name="poDueDt" id="poDueDt"
