...
<script type="text/javascript" src="script/PORegist/poThrLoan.js"></script>
</head>
<body class="UTSCF">
	<form id="loanForm">
			...
			<table class="utTab">
				...
				<tr>
					...
					<td><input type="text" name="loanDueDt" id="loanDueDt"
						editable="false" class="easyui-datebox" required="required"
						data-options="validType:'date',onChange:getDueDt"></td>
				</tr>
				<tr>
					<td>订单编号：</td>
					<td><input type="text" class="easyui-validatebox combo"
						...
						data-options="validType:'maxLength[35]'"></input><a
						class="easyui-linkbutton" icon="icon-search"
						onclick="showLookPoWindow()">查询</a></td>
					<td>订单金额：</td>
				...
				<tr id="Tr6">
					...
					<td><input class="easyui-validatebox combo" id="marginAcNo"
						name="marginAcNo" data-options="validType:'maxLength[35]'" /></td>
				</tr>
				<tr>
					<td>手续费：</td>
				...
				<tr id="Tr1">
					...
					<td><input id="loanRt" name="loanRt" type="hidden"></td>
					<td><input id="transChgrt" name="transChgrt" type="hidden"></td>
		...
		<div id="poDiv">
			<div class="easyui-panel" title="商品信息列表"
				data-options="collapsible:true" style="width: 100%">
				<div id="CollaterDiv">
					<table id="poTable" cellspacing="0" cellpadding="0"
