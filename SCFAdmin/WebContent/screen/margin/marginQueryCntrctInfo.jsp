...
<script type="text/javascript"
	src="script/margin/marginQueryCntrctInfo.js"></script>
</head>
<body>
	<div>
		<form id="searchForm">
					...
					<ul class="condList clearfix" id="moreSearchUl">
						...
						<li class="condLists fL clearfix"><label
							class="dsB fL tR labelStyle">业务类别:</label> <span class="dsB fL">
								<input id="busiTp" name="busiTp"
								class="easyui-combobox  queryInputStyleTwo"
								data-options="valueField:'id',textField:'text',panelHeight: 'auto'"
								editable="false"></input>
						</span></li>
						<li class="condLists fL clearfix"><label
							class="dsB fL tR labelStyle">币别:</label> <span class="dsB fL">
								<input class="easyui-combobox queryInputStyleTwo" id="ccy"
								name="ccy"
								data-options="valueField: 'sysRefNo',textField: 'sysRefNo',panelHeight: 'auto'"
								editable="false" /></input>
						</span></li>
