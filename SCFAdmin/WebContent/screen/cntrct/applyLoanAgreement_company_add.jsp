...
<script type="text/javascript"
	src="script/cntrct/applyLoanAgreement_company_add.js"></script>
</head>
<body>
	<form id="mainForm">
			...
			<div class="item">
				...
				<div class="fl item-ifo">
					<input type="text" class="easyui-validatebox combo"
						...
						onclick="showDetails()" />
						<input type="hidden" value="0" name="finaTp" id="finaTp" /> 
						...
						<input type="hidden" name="acNm" id="acNm" /> 
						<input type="hidden" name="acBkNm" id="acBkNm" /> 
						<input type="hidden" value="0" name="acTp" id="acTp" />
						<input type="hidden" name="arBal" id="arBal" />
						<input type="hidden" name="payChgTp" id="payChgTp" /> 
