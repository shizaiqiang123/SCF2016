...
<title>交易首页</title>
<script type="text/javascript" src="script/cntrct/dspPage.js"></script>
		...
		<div id="cntrcHome">
			<form id="cntrcForm">
				<div id="noticeDiv" style="width: 100%" class="easyui-panel"
					...
					<div class="item">
						<span class="label">争议流水号：</span>
						<div class="fl item-ifo">
							<input type="text" class="easyui-validatebox combo"
								name="sysRefNo" id="sysRefNo" required="true"></input><a
					...
					-->
					<div class="item">
						<span class="label">争议登记日期：</span>
						<div class="fl item-ifo">
							<input id="trxDt" name="trxDt" class="easyui-validatebox combo"
								data-options="width:'253px',height:'32px',valueField:'id',textField:'text',panelHeight: 'auto'"
								editable="false"></input>
						</div>
					</div>
					<div class="item">
						<div class="fl item-ifo">
							...
							<input type="hidden" name="notifyBy" id="notifyBy"></input>
							<input type="hidden" name="ttlDspInvNo" id="ttlDspInvNo"></input>
							<input type="hidden" name="ttlDspInvAmt" id="ttlDspInvAmt"></input>
							<input type="hidden" name="dspFlag" id="dspFlag"></input>
