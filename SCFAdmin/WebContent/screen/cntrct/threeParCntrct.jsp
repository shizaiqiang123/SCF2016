...
<script type="text/javascript" src="script/cntrct/threeParCntrct.js"></script>
</head>
<body>
	<div class="div_ul">
		<form id="cntrctForm">
				...
				<table class="utTab">
					...
					<tr>
						...
						<td><input id="busiTp" name="busiTp" class="easyui-combobox"
							...
							editable="false" required="true" value="2"></input></td>
						<td>授信客户编号：</td>
					...
					<tr id="Tr10">
						...
						<td id=openLoanAmtTd><input type="text" name="openLoanAmt"
							id="openLoanAmt" class="easyui-numberbox" readOnly="readOnly"
							data-options="min:0,precision:2,groupSeparator:','"></input></td>
					</tr>
					<tr>
						<td>罚息利率：</td>
					...
					<tr id="Tr4">
						...
						<td id="pldPercD"><input type="text" name="pldPerc"
							value="100" id="pldPerc" class="easyui-numberspinner"
							data-options="min:0,precision:2,max:100,suffix:'%'"></input></td>
						<td id="initGartPctT">初始化保证金比例：</td>
						<td id="initGartPctD"><input type="text" name="initGartPct"
							value="0" id="initGartPct" class="easyui-numberspinner"
							required="true"
							data-options="min:0,precision:2,max:100,suffix:'%'"></input></td>
					</tr>
					<tr>
						...
						<td><input type="text" name="transChgrt" id="transChgrt"
							...
							data-options="min:0,precision:2,max:100,suffix:'%'"></input></td>
						<td>费用收取方式：</td>
						<td><input id="payChgTp" name="payChgTp"
							class="easyui-combobox"
							data-options="valueField:'id',textField:'text',panelHeight: 'auto'"
							editable="false" value="1"></input></td>
					</tr>
					...
					<div id="acnoDiv1">
						...
						<div id="toolbar1" style="overflow: hidden">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								...
								iconcls="icon-remove" onclick="deleteSbrRow()" plain="true"
								style="float: right">删除</a> <a href="javascript:void(0)"
								class="easyui-linkbutton" iconcls="icon-edit"
								onclick="editSbrRow()" plain="true" style="float: right">修改</a>
							<a href="javascript:void(0)" class="easyui-linkbutton"
								iconcls="icon-search" onclick="inqSbrRow()" plain="true"
					...
					<div id="collatDiv">
						...
						<div id="collatToolbar" style="overflow: hidden">
							<a href="javascript:void(0)" class="easyui-linkbutton"
								...
								onclick="deleteCollat()" plain="true" style="float: right">删除</a><a
								href="javascript:void(0)" class="easyui-linkbutton"
								iconcls="icon-edit" onclick="editCollat()" plain="true"
								style="float: right">修改</a> <a href="javascript:void(0)"
								class="easyui-linkbutton" iconcls="icon-search"
								onclick="inqCollat()" plain="true" style="float: right">查询</a>
						</div>
					</div>
				</div>
			</div>
