...
<script type="text/javascript" src="script/cntrct/queryCntrctTemp.js"></script>
<style type="text/css">
input,button {
	border-width: 0;
	outline: 0;
			...
			<div class="easyui-panel blockArea panel-body" title="查询条件"
				...
				<ul class="condList clearfix" id="screenDiv">
					<li class="condLists fL clearfix">
						...
						<span class="dsB fL">
							<input type="text" id="sysRefNo" class="inputM1 combo" name="sysRefNo" />
							<input type="hidden" name="selId" id="selId" value="${sysUserInfo.userOwnerId }" />
							<input type="hidden" name="licenceNo" id="licenceNo" />
						</span>
					</li>
					<li class="condLists fL clearfix"><label class="dsB fL tR">产品名称：</label>
						<span class="dsB fL"> <input type="text" id="productNm"
							class="inputM1 combo" name="productNm" />
					</span></li>
