...
<title>流水号管理</title>
<script type="text/javascript" src="script/cntrct/custLookUp.js"></script>
</head>
<body>
	<div class="window-form">
		...
		<input type="hidden"  name ="selNo" id="selNo" title="授信客户编号" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>
			...
			<ul class="condList clearfix" id="screenDiv">
				<div class="selectDiv" id="selectDiv">
					...
					<li class="condLists fL clearfix"><span class="dsB fL height34">
							<input class="inputM1 combo queryInputStyleThree" type="text" name="sysRefNo"
							id="sysRefNo" placeholder="间接客户编号" />
					</span></li>
					<li class="condLists fL clearfix">
						<div class="inputOfCenterLine"></div>
					</li>
					<li class="condLists fL clearfix"><span class="dsB fL height34">
							<input class="inputM1 combo queryInputStyleThree" type="text" name="selNo"
							id="selNo" placeholder="授信客户编号" />
					</span></li>
				</div>
				<li>
