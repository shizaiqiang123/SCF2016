...
<title>间接客户查询</title>
<script type="text/javascript" src="script/cntrct/queryCntBuyer.js"></script>
</head>
<body>
	<div>
		<form id="searchForm">
			<!-- <label>间接客户编号：</label>
		<input type="text"  name ="buyerId" id="buyerId" title="授信客户编号" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>
		<label>间接客户名称：</label>
		<input type="text"  name ="buyerNm" id="buyerNm" title="授信客户编号" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>		
