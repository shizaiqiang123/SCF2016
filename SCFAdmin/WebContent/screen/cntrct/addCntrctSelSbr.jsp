...
<script type="text/javascript" src="script/cntrct/addCntrctSelSbr.js"></script>
</head>
<body>
			...
			<table class="utTab">
				...
				<tr id="Tr3">
					...
					<td><input type="text" name="acctPeriod" id="acctPeriod"
						required="true" class="easyui-numberspinner"
						data-options="min:0,max:9999"></input></td>
				</tr>
				<tr id="Tr4">
					<td>赊销宽限期：</td>
					<td><input type="text" name="openactGraceDay" required="true"
				...
				<tr>
					...
					<td><input type="hidden" name="selAmtHd" id="selAmtHd"></td>
