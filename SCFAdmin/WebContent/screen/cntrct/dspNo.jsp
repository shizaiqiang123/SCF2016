...
<script type="text/javascript" src="script/cntrct/dspNo.js"></script>
<style type="text/css">
input, button {
	border-width: 0;
	outline: 0;
		...
		<form id="searchForm">
			<!-- <div class="easyui-panel blockArea panel-body" title="查询条件"
				...
				<ul class="condList clearfix" id="screenDiv">
					<li class="condLists fL clearfix"><label class="dsB fL tR">争议提出方：</label>
						<span class="dsB fL"> <input type="text" id="notifyBy"
							class="inputM1 combo" name="notifyBy" />
					</span></li>
			...
			<ul class="condList clearfix" id="screenDiv">
				<div class="selectDiv" id="selectDiv">
					...
					<li class="condLists fL clearfix"><span class="dsB fL height34">
							<input class="inputM1 combo queryInputStyleThree" type="text" name="notifyBy"
							id="notifyBy" placeholder="争议提出方" />
					</span></li>
					<li class="condLists fL clearfix">
						<div class="inputOfCenterLine"></div>
					</li>
					<li class="condLists fL clearfix"><span class="dsB fL height34">
							<input class="inputM1 combo queryInputStyleThree" type="text" name="selNm"
							id="selNm" placeholder="授信客户名称" />
					</span></li>
				</div>
				<li>
