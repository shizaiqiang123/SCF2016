...
<title>交易首页</title>
<script type="text/javascript" src="script/cntrct/cntrctHomePageYf.js"></script>
	...
	<div id="cntrcHome">
		<form id="cntrcHomeForm">
			...
			<div class="item">	
				...
				<div class="fl item-ifo"><input id="ccy"  name="ccy" class="easyui-combobox" 
					data-options="width:'253px',height:'32px',valueField:'id',textField:'text',panelHeight: 'auto'"
				 	editable="false"  ></input></div>
			</div>
			<div class="item">
				<div class="fl item-ifo">
					<input type="hidden"  name="patnerId" id="patnerId" ></input>
					<input type="hidden"  name="patnerNm" id="patnerNm" ></input>
					...
					<input type="hidden"  name="buyerNm" id="buyerNm" ></input>
					<input type="hidden"  name="initThFlg" id="initThFlg" ></input>
					<input type="hidden"  name="pldPerc" id="pldPerc" ></input>
					<input type="hidden"  name="initMarginPct" id="initMarginPct" ></input>
				</div>
			 </div>
	       </div>
		</form>
