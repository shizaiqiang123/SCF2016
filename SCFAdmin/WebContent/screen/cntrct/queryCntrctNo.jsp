...
<script type="text/javascript" src="script/cntrct/queryCntrctNo.js"></script>
<style type="text/css">
input, button {
	border-width: 0;
	outline: 0;
...
<body class="SYS_Catalog">
	...
	<form id="searchForm">
		<label>协议编号：</label>
		<input type="text"  name ="cntrctNo" id="cntrctNo" title="协议编号" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>
		<label>授信客户编号：</label>
		<input type="text"  name ="selNm" id="selNm" title="授信客户编号" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>		
