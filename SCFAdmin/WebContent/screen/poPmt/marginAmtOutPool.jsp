...
<title>保证金出池页面</title>
<script type="text/javascript" src="script/poPmt/marginAmtOutPool.js"></script>
</head>
<body>
	<div id="loanDiv" style="width: 98%" class="easyui-panel" title="基本信息"
		...
		<form id="loanForm">
			<table class="utTab">
				...
				<tr>
					<td>应收账款余额：</td>
					<td><input class="easyui-numberbox" name="arBal"
						id="arBal" required="required"
						data-options="min:0,precision:2,groupSeparator:','" value=0 /></td>
					<td>可出池金额：</td>
					<td><input class="easyui-numberbox" name="arMarginAmt"
						id="arMarginAmt" required="required"
						data-options="min:0,precision:2,groupSeparator:','" /></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" class="easyui-validatebox combo"
						...
						data-options="validType:'maxLength[30]'" required="true" /></td>
					<td>本次出池金额：</td>
					<td><input class="easyui-numberbox" name="marginAmt"
						id="marginAmt" required="true"
						data-options="min:0,precision:2,groupSeparator:',',onChange:changeMarginAmt" /></td>
				</tr>

				<tr>
					<td><input type="hidden" id="inoutTp" name="inoutTp" value="1"></td>
					...
					<td><input type="hidden" id="arMarginAmtOld" name="arMarginAmtOld"></td>
				</tr>
