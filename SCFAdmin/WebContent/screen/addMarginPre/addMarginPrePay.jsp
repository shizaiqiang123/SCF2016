...
<script type="text/javascript" src="script/addMarginPre/addMarginPrePay.js"></script>
</head>
<body class="UTSCF">
	<form id="addMargin">
		<div id="addMarginDiv" style="width: 100%" class="easyui-panel"
			...
			<table class="utTab">
				<tr>
					<td>协议编号：</td>
					<td><input type="text" name="cntrctNo" id="cntrctNo" class="easyui-validatebox combo"
						 data-options="validType:'maxLength[35]'"></td>
					<td>协议流水号：</td>
					<td><input type="text" name="sysRefNo" id="sysRefNo" class="easyui-validatebox combo"
						data-options="validType:'maxLength[35]'"></td>
				</tr>
				<tr>
					<td>间接客户编号：</td>
					...
					<td>间接客户名称：</td>
					<td><input type="text" name="selNm" id="selNm" class="easyui-validatebox combo"
						data-options="validType:'maxLength[35]'"></input></td>
				</tr>
				<tr>
					<td>授信客户编号：</td>
				...
				<tr>
					...
					<td><input type="text" name="patnerId" id="patnerId"
						 ...
						 data-options="validType:'maxLength[35]'"></input></td>
					<td>监管机构名称：</td>
					<td><input type="text" name="patnerNm" id="patnerNm"
					     class="easyui-validatebox combo"  
				...
				<tr>
					...
					<td><input type="text" name="storageId" id="storageId"
						 ...
						 data-options="validType:'maxLength[35]'"></input></td>
					<td>仓库名称：</td>
					<td><input type="text" name="storageNm" id="storageNm" 
					     class="easyui-validatebox combo" 
						 data-options="validType:'maxLength[70]'"></input></td>
				</tr>
				<tr>
					...
					<td><input type="text" name="storageAdr" id="storageAdr"
					    class="easyui-validatebox combo" 
						data-options="validType:'maxLength[14]'"></input></td>
					<td>仓库联系人：</td>
