...
<script type="text/javascript" src="script\para\BasalRate_Edit.js"></script>
</head>
		...
		<form id="screenForm">
			<div class="easyui-panel blockArea panel-body" title="查询条件"
				...
				<ul class="condList clearfix" id="screenDiv">
					...
					<li class="condLists fL clearfix"><label class="dsB fL tR">融资模式：</label>
						<span class="dsB fL"> <input type="text" id="finaTp"
							class="easyui-combobox" name="finaTp"
							data-options="valueField: 'id',textField: 'text',panelHeight: 'auto',width:'176px',height:'32px'" />
					</span></li>
					<li class="condLists fL clearfix"><label class="dsB fL tR">融资期限：</label>
						<span class="dsB fL"> <input type="text" id="acctPeriod"
							class="inputM1 combo" name="acctPeriod" />
					</span></li>
					<li class="condLists fL clearfix"><label class="dsB fL tR">利率费率：</label>
						<span class="dsB fL"> <input type="text" id="feeOrIntr"
							class="easyui-combobox" name="feeOrIntr"
							data-options="valueField: 'id',textField: 'text',panelHeight: 'auto',width:'176px',height:'32px'" />
					</span></li>
				...
				<div id="pageToolbar" style="overflow:hidden;">
					<a href="javascript:void(0)" class="easyui-linkbutton"
				   	...
				   	<a href="javascript:void(0)"
						class="easyui-linkbutton" id="editButton"
						iconcls="icon-edit" onclick="editButton()" plain="true" style="float:right;">修改</a>
					<a href="javascript:void(0)" class="easyui-linkbutton"
						id="delButton" iconcls="icon-remove"
						onclick="delButton()" plain="true" style="float:right;">删除</a>
				</div>
