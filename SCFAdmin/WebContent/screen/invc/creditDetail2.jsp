...
<script type="text/javascript" src="script/invc/creditDetail2.js"></script>
</head>
<body>
		...
		<div class="easyui-panel" title="贷项清单信息" data-options="collapsible:true" style="width: 98%">
			<table class="utTab" align="center" height="50%">
				...
				<tr>
					...
					<!-- 
					<td>应收账款编号：</td>
					<td><input type="text" name="linkInvNo" id="linkInvNo" class="easyui-validatebox combo" ></td>
					 -->
					<!-- <td>关联应收账款流水号：</td> -->
					<td>协议编号：</td>
					...
					<td>币别：</td>
					<td>
					  <input class="easyui-combobox" id="invCcy" name="invCcy"
				...
				<tr>
					...
					<td><input type="text" name="invBal" id="invBal"
						data-options="min:0,precision:2,groupSeparator:','"
						class="easyui-numberbox"></td>
					<!-- <td><input type="text" name="invBal" id="invBal"></td> -->
					<td>融资余额：</td>
					<td><input type="text" name="invLoanBal" id="invLoanBal"
						data-options="min:0,precision:2,groupSeparator:','"
						class="easyui-numberbox"></td>
					<!-- <td><input type="text" name="invLoanBal" id="invLoanBal"></td> -->
				</tr>
				<tr>
					<td>贷项清单金额：</td>
					<!-- -->
					...
					<!-- <td><input type="text" name="crnAmt" id="crnAmt"></td> -->
					<td>贷项清单余额：</td>
					<!--  -->
					<td><input type="text" name="invBal2" id="invBal2"
						data-options="min:0,precision:2,groupSeparator:','"
						class="easyui-numberbox" readonly="readonly"></td>
						
					<!-- <td><input type="text" name="invBal2" id="invBal2"></td> -->
				</tr>
				<tr>
