...
<script type="text/javascript" src="script/invc/dspChg.js"></script>
</head>
<body>
			...
			<table class="utTab" align="center" height="60%">
				<tr>
					...
					<td><input type="text" name="buyerId"
						class="easyui-validatebox" id="buyerId" required="true"></input><a
				...
				<tr>
					<td>应收账款凭证编号：</td>
					<td><input type="text" class="easyui-validatebox" name="invNo"
				...
				<tr>
					...
					<td><input type="text" name="otherRsn" id="otherRsn"
						class="easyui-textbox" data-options="validType:'maxLength[200]'"></input></td>
				</tr>
				<tr>
					<td>争议标识：</td>
