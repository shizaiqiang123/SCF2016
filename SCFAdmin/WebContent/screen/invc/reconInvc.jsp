...
<title>应收账款销账</title>
<script type="text/javascript" src="script/invc/reconInvc.js"></script>
</head>
<body>
<form id="invcMForm">
    		...
    		<tr>
    			...
    			<td><input class="easyui-combobox"  id=invCcy name="invCcy"
				 	data-options="valueField: 'sysRefNo',textField: 'sysRefNo',panelHeight: 'auto'" 
				 	 editable="false" ></td>
    			<td>应收账款金额：</td>
    			<td><input type="text"  name="invAmt" id="invAmt"   data-options="min:0,precision:2,groupSeparator:','" class ="easyui-numberspinner" required="required"></td>
    		</tr>
    		<tr>
    			<td>应收账款余额：</td>
    			<td><input id="invBal" name ="invBal" data-options="min:0,precision:2,groupSeparator:','"  class ="easyui-numberspinner" readonly="readonly" ></td>
    			<td>融资余额：</td>
