...
<script type="text/javascript" src="script/invc/invcMPool.js"></script>
</head>
<body>
	<form id="invcMForm">
			...
			<table class="utTab">
				...
				<tr>
					...
					<td><input type="text" name="regAmt" id="regAmt"
						...
						data-options="min:0,precision:2,groupSeparator:','" value=0></input></td>
					<!-- <td>手续费：</td>
    			<td><input type="text"  name="pdgAmt" id="pdgAmt" class="easyui-numberbox" data-options="min:0,precision:2,groupSeparator:','" value=0></input></td> -->
					<td>应收账款处理费金额：</td>
				...
				<tr>
					...
					<!-- <td>扣息方式：</td> -->
					<td id = "payIntTpTd"><input id="payIntTp" name="payIntTp"
						class="easyui-combobox"
						data-options="valueField:'id',textField:'text',panelHeight: 'auto'"
						editable="false"></input></td>
				</tr>
