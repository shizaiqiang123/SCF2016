...
<script type="text/javascript" src="script/invc/invcCdn.js"></script>
</head>
<body>
	<form id="cdnRegForm">
		<div class="easyui-panel" title="交易信息" data-options="collapsible:true"
			...
			<div id="cbkRegDiv">
				<table class="utTab">
					...
					<tr>
						<!-- <td>业务类别：</td>
					<td><input id="busiTp" name="busiTp" class="easyui-combobox" data-options="valueField:'id',textField:'text',panelHeight: 'auto'" editable="false"/></td> -->
						<td>授信客户名称：</td>
		...
		<div id="invcCbkDiv" class="easyui-panel" title="应收账款列表"
			...
			<div id="toolbar" style="overflow: hidden;">
				<!-- <a href="javascript:void(0)" class="easyui-linkbutton" id="querybutton" iconcls="icon-add" onclick="queryInvc()" plain="true">应收账款查询</a> -->
				<a href="javascript:void(0)" class="easyui-linkbutton"
					iconcls="icon-edit" onclick="editRow()" plain="true"
					style="float: right; margin-right: 14px;">修改</a> 
				<a href="javascript:void(0)" class="easyui-linkbutton" id="invcInfo"
					name="invcInfo" id="querybutton" iconcls="icon-search"
					onclick="queryInvc()" plain="true"
					style="float: right; margin-right: 14px;">发票查询</a>
				<!-- <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-remove" onclick="deleteRow()" plain="true" style="float:right;">删除</a> -->
				<!-- 不能删除发票 -->
			</div>
		</div>
