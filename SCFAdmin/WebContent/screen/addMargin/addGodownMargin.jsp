...
<script type="text/javascript" src="script/addMargin/addGodownMargin.js"></script>
</head>
<body class="UTSCF">
	<form id="addMargin">
			...
			<table class="utTab">
				...
				<tr>
					...
					<td><input name="loanId" id="loanId"
						...
						<a id="poButton" class="easyui-linkbutton" icon="icon-search" onclick="onSearchPoClick()">查询</a></td>
				</tr>
				<tr>
					<td>融资金额：</td>
