...
<title>质物入库页面</title>
<script type="text/javascript" src="script/collatRef/collatRef.js"></script>
</head>
<body class="UTSCF">
	<form id="POForm">
			...
			<table class="utTab">
				...
				<tr>
					...
					<td><input type="text" name="ccy" id="ccy"
						data-options="valueField: 'sysRefNo',textField: 'sysRefNo',panelHeight: 'auto'"
						class="easyui-combobox" required="true" style="width: 60px" editable="false"></input>
						<input type="text" name="regAmt" id="regAmt"
						class="easyui-numberspinner" style="width: 115px;"
				...
				<tr>
					<td>库存价值：</td>
					<td><input name="ttlRegAmt" id="ttlRegAmt"
						class="easyui-numberspinner"
						data-options="groupSeparator:',', min:0,precision:2"
						editable="false"></input></td>
					<!-- <td>最大跌幅率：</td>
					<td><input name="maxDroPerc" id="maxDroPerc"
						...
						></input></td> -->
					<td><input type="hidden" name="numTtlRegAmt" id="numTtlRegAmt" />
					<td><input type="hidden" name="storageAdr" id="storageAdr" />
					<td><input type="hidden" name="contactNm" id="contactNm" />
				</tr>
			</table>
		</div>
