...
<script type="text/javascript" src="script/collatRef/queryGoodsId.js"></script>
</head>
<body>
	<div class="window-form">
		<form id="searchForm">
			<!-- <label>商品编号：</label>
		<input type="text"  name ="collatId" id="collatId" title="授信客户编号" class="easyui-validatebox combo" data-options="validType:'maxLength[35]'"/>
