...
<body class="demo">
	<div style="margin:50px 0px 0px 50px;padding-bottom:50px">
		<img  class="sr" src="images/flowChart/line3.png">
		<div class="dengji">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000028');">
				<img  src="images/flowChart/dingdan.png">
				<span class="world">订单</span>
			</a>
		</div>
		<div class="zhuangrang">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000035');">
				<img  src="images/flowChart/rongzhi.png">
				<span class="world">融资</span>
			</a>
		</div>
		<div class="rongzhi">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000448');">
				<img  src="images/flowChart/ruku.png">
				<span class="world">入库</span>
			</a>
		</div>
		<div class="maifu">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000084');">
				<img  src="images/flowChart/baozhengj.png">
				<span class="world" style="margin-left:10px;">保证金</span>
			</a>
		</div>
		...
		<div class="zhengyi">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000081');">
				<img  src="images/flowChart/chuku.png">
				<span class="world">出库</span>
			</a>
		</div>
		<div class="daixiang">
			<a href="javascript:void(0);" onclick="javascript:clickEvent('F_P_000030');">
