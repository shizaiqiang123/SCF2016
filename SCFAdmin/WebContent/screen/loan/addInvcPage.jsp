...
<script type="text/javascript" src="script/loan/addInvcPage.js"></script>
</head>
<body>
	<div style="margin-bottom: 20px;">
		<form id="searchForm">
			<!-- <label>间接客户ID：</label>
			<input type="text" name="invcBuyerId" id="invcBuyerId" title="间接客户ID" /> 
			<label>间接客户名称：</label> 
			<input type="text" name="invcBuyerNm" id="invcBuyerNm" title="间接客户名称" />
			<label>发票号：</label> 
			<input type="text" name="queryInvNo" id="queryInvNo" title="发票号" />  
			<a class="easyui-linkbutton" icon="icon-search" onclick="searchInvcCata()">查询</a> -->
