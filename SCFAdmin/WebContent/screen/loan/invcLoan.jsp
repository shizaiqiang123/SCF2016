...
<script type="text/javascript" src="script/loan/invcLoan.js"></script>
</head>
<body class="UTSCF">
	<form id="loanSubmit">
			...
			<table class="utTab">
				...
				<tr>
					...
					<td><input  name="totalLoan" id="totalLoan"
						class="easyui-numberspinner" editable="false"data-options="min:0,precision:2,groupSeparator:','"></input></td>
					<td>融资到期日：</td>
				...
				<tr id="Tr2">
					...
					<td><input name="trxDt" id="trxDt" class="easyui-datebox" value="${sysUserInfo.sysDate }"></td>
				...
				<tr id="Tr1">
					<td><input  name="tempMarginAmt" id="tempMarginAmt" class="easyui-numberbox"
