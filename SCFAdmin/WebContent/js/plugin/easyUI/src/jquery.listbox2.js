    ...
    $.fn.listbox = function (options) {
        ...
        if (typeof options == 'string') {
            ...
            if (options in list) {
                ...
                throw 'listbox not contains such function';
            }
        }
        function build() {
            return $.extend({
        ...
        var list = {
            ...
            addItem: function (data) {
                ...
                if (data instanceof Array || (!(options.valueField in data) || (!options.textField in data))) {
                    finallyData.value = data[0];
                    finallyData.text = data[1];
                }
                var item = $('<li class="ui-menu-item ui-corner-all"><a value="' + finallyData[options.valueField] + '" class="ui-corner-all" tabindex="-1">' + finallyData[options.textField] + '</a>');
                ts.append(item);
            ...
            getData: function (a) {
                if (a) {
                    ...
                    return { value: a.attr('value'), text: a.text() };
                } else {
                    return null;
                }
            },
            ...
            setSelection: function (value) {
                ...
                $('a[value="' + value + '"]', ts).addClass('ui-state-active');
            },
            clear: function () {
                ts.empty();
            },
