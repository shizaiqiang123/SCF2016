...
//原先公式为:tb.width()-_46a.length*opts.iconWidth-btn._outerWidth()应该是151-18=133的，but最后生成却为125px（自动少8）;datebox显示会留白textbox下拉框显示正常
//现改为tb.width()+8，完全伸展至input末端
_468._outerWidth(tb.width()+8);
tb.insertAfter(_464);
...
//tb.removeClass("textbox-invalid");
	box.parent('span').parent('td').removeClass("textbox-invalid");//给下拉控件和时间控件的tb行内加上*号
}else{
//tb.addClass("textbox-invalid");
	box.parent('span').parent('td').addClass("textbox-invalid");
}
}}));
};
function _472(_473){
