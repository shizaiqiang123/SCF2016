...
loading:function(param){
	var _20={close:function(){
		var win=$("body>div.messager-window>div.messager-body:has(div.messager-loading)");
	...
	if(typeof param=="string"){
		var method=_20[param];
		return method();
	}
	//_22
	var options=$.extend({title:"",msg:"",text:undefined,interval:300},param||{});
	//_23
	var panel="<div class=\"messager-loading\"><div class=\"messager-loading-icon\"></div><div class=\"messager-loading-msg\">" + options.loadingMsg +"</div></div>";
	var win=_f(options.title,panel,null);
