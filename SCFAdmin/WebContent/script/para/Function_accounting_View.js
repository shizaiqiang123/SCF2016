...
//						$('#mainForm').append("<input type='hidden' id=\"initisable\" name=\"initisable\"  value=\"N\" >");
					}
					else
					{
...
//						$('#mainForm').append("<input type='hidden'  id=\"initisable\" name=\"initisable\"  value=\"Y\" >");
					}
//					$('#mainForm').append("<input type='hidden' id=\"ddata\" name=\"ddata\"  value=\""+data.obj+"\" >");						
				}
			}
	};
