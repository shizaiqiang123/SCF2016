	...
	$.each(datas, function(i, n) {
		...
		if ('PM' === SCFUtils.FUNCTYPE) {
			...
			if(relQueryLmtERe()[0] == undefined){
				...
				objHD.sysRefNo = relQueryLmtERe()[0].sysRefNo;
			}
		}
...
function loadChgBusiTp(custTp) {
	...
	$("#finaTpTd").hide();
	$('tr[id=Tr17]').hide();
	if (custTp == '0' || custTp == '1' || custTp == '8' || custTp == '9') {
		// $('#finaTp').combobox({
		// required : true
		// });
